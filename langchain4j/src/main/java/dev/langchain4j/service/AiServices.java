...
public abstract class AiServices<T> {
    ...
    /**
     * When {@code true}, tool registration fails with an exception if a {@link Tool @Tool} method parameter
     * resolved to an autogenerated name such as {@code arg0}. This happens when the {@code -parameters}
     * javac option is not enabled, which causes the original parameter names to be lost during compilation,
     * and may confuse the LLM.
     *
     * <p>
     * To fix the underlying problem, either:
     * <ul>
     *     <li>enable the {@code -parameters} javac option (enabled by default in Spring Boot and Quarkus), or</li>
     *     <li>annotate the parameter with {@code @P(name = "...")}.</li>
     * </ul>
     *
     * <p>
     * The default value is {@code false}.
     *
     * @param strictToolParameters whether to fail on autogenerated parameter names
     * @return the builder instance
     */
    public AiServices<T> strictToolParameters(boolean strictToolParameters) {
        context.toolService.strictToolParameters(strictToolParameters);
        return this;
    }
