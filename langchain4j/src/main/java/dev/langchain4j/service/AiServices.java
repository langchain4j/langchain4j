...
public abstract class AiServices<T> {
     ...
     */
    public AiServices<T> inputGuardrailClasses(@Nullable List<Class<? extends InputGuardrail>> guardrailClasses) {
     ...
     */
    public AiServices<T> inputGuardrailClasses(@Nullable Class<? extends InputGuardrail>... guardrailClasses) {
        context.guardrailServiceBuilder.inputGuardrailClasses(guardrailClasses);
        return this;
    }
     ...
     */
    public AiServices<T> outputGuardrailClasses(@Nullable List<Class<? extends OutputGuardrail>> guardrailClasses) {
     ...
     */
    public AiServices<T> outputGuardrailClasses(@Nullable Class<? extends OutputGuardrail>... guardrailClasses) {
        context.guardrailServiceBuilder.outputGuardrailClasses(guardrailClasses);
        return this;
    }
