...
public abstract class AbstractGuardrailService implements GuardrailService {
    ...
    @Override
    public <MethodKey> InputGuardrailResult executeGuardrails(@Nullable MethodKey method, InputGuardrailParams params) {
    ...
    @Override
    public <MethodKey> OutputGuardrailResult executeGuardrails(
