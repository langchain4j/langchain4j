...
public interface GuardrailService {
     ...
     */
    <MethodKey> InputGuardrailResult executeGuardrails(@Nullable MethodKey method, InputGuardrailParams params);
     ...
     * @param <MethodKey>> The type of the method key, representing a unique identifier for methods.
     */
    <MethodKey> OutputGuardrailResult executeGuardrails(@Nullable MethodKey method, OutputGuardrailParams params);
    ...
    interface Builder {
         ...
         * @return The current instance of {@link Builder} for method chaining.
         */
        Builder inputGuardrailClasses(@Nullable List<Class<? extends InputGuardrail>> guardrailClasses);
         ...
         * @return The current instance of {@link Builder} for method chaining.
         */
        default Builder inputGuardrailClasses(@Nullable Class<? extends InputGuardrail>... guardrailClasses) {
         ...
         * @return The current instance of {@link Builder} for method chaining.
         */
        Builder outputGuardrailClasses(@Nullable List<Class<? extends OutputGuardrail>> guardrailClasses);
         ...
         * @return The current instance of {@link Builder} for method chaining.
         */
        default Builder outputGuardrailClasses(Class<? extends OutputGuardrail>... guardrailClasses) {
            return Optional.ofNullable(guardrailClasses)
