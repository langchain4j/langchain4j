...
public class LocalAiEmbeddingModel implements EmbeddingModel, TokenCountEstimator {
    ...
    public static void main(String[] args) {
        Embedding hello = LocalAiEmbeddingModel.builder()
                .modelName("text-embedding-ada-002")
                .timeout(ofSeconds(60))
                .url("http://localhost:8145")
                .build()
                .embed("hello");
        System.out.println(Arrays.toString(hello.vector()));
    }

    @Builder
    public LocalAiEmbeddingModel(String url,
                                 String modelName,
                                 Duration timeout,
                                 Integer maxRetries,
                                 Boolean logRequests,
        ...
        timeout = timeout == null ? ofSeconds(40) : timeout;
