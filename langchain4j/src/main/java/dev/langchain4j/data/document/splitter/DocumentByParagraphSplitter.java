...
public class DocumentByParagraphSplitter extends HierarchicalDocumentSplitter {
    ...
    public DocumentByParagraphSplitter(int maxSegmentSizeInChars, DocumentSplitter childSplitter) {
    ...
    public DocumentByParagraphSplitter(int maxSegmentSizeInTokens, Tokenizer tokenizer, DocumentSplitter childSplitter) {
