...
public class TokenWindowChatMemory implements ChatMemory {
    ...
    public static TokenWindowChatMemory fromJson(String json, int size, TokenCountEstimator tokenCountEstimator) {
        List<ChatMessage> messages = ChatMessageDeserializer.messagesFromJson(json);
        TokenWindowChatMemory chatMemory = TokenWindowChatMemory.withMaxTokens(size, tokenCountEstimator);
