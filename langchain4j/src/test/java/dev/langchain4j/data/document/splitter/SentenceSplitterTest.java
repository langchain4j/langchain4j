...
//        );
//
//        SplitJoinSentences splitter = new SplitJoinSentences(maxSegmentSize);
//
...
//        );
//
//        DocumentSplitter splitter = new SplitJoinSentences(maxSegmentSize);
//
//        List<TextSegment> segments = splitter.split(document);
//
//        segments.forEach(segment ->
...
//        DocumentSplitter splitter = new SplitJoinSentences(maxSegmentSize, tokenizer);
//
//        List<TextSegment> segments = splitter.split(document);
//
//        segments.forEach(segment ->
