...
class DocumentByParagraphSplitterTest {
    ...
    void should_split_into_segments_with_one_paragraph_per_segment(String separator) {
        ...
        assertThat(segments).containsExactly(
                textSegment(firstParagraph, metadata("index", "0").put("document", "0").put("startIndex", "0")),
                textSegment(secondParagraph, metadata("index", "1").put("document", "0").put("startIndex", "27"))
        );
    }
    ...
    void should_split_into_segments_with_multiple_paragraphs_per_segment(String separator) {
        ...
        segments.forEach(segment ->
                assertThat(segment.text().length()).isLessThanOrEqualTo(maxSegmentSize));
        assertThat(segments).containsExactly(
                textSegment(firstParagraph + "\n\n" + secondParagraph, metadata("index", "0").put("document", "0").put("startIndex", "0")),
                textSegment(thirdParagraph, metadata("index", "1").put("document", "0").put("startIndex", "56"))
        );
    }
    ...
    void should_split_paragraph_into_sentences_if_it_does_not_fit_into_segment(String separator) {
        ...
        assertThat(segments).containsExactly(
                textSegment(firstParagraph, metadata("index", "0").put("document", "0").put("startIndex", "0")),
                textSegment(firstSentenceOfSecondParagraph, metadata("index", "1").put("document", "0").put("startIndex", "27")),
                textSegment(secondSentenceOfSecondParagraph, metadata("index", "2").put("document", "0").put("startIndex", "74")),
                textSegment(thirdParagraph, metadata("index", "3").put("document", "0").put("startIndex", "123"))
        );
    }
    ...
    void should_split_sample_text_containing_multiple_paragraphs() {
        ...
        assertThat(segments).containsExactly(
                textSegment(p1, metadata("index", "0").put("document", "0").put("startIndex", "0")),
                textSegment(p2p1, metadata("index", "1").put("document", "0").put("startIndex", "329")),
                textSegment(p2p2, metadata("index", "2").put("document", "0").put("startIndex", "603")),
                textSegment(p3, metadata("index", "3").put("document", "0").put("startIndex", "786")),
                textSegment(p4p1, metadata("index", "4").put("document", "0").put("startIndex", "985")),
                textSegment(p4p2, metadata("index", "5").put("document", "0").put("startIndex", "1234")),
                textSegment(p5 + "\n\n" + p6, metadata("index", "6").put("document", "0").put("startIndex", "1294")),
                textSegment(p7, metadata("index", "7").put("document", "0").put("startIndex", "1522"))
        );
    }
    ...
    void should_split_sample_text_containing_multiple_paragraphs_with_overlap() {
        ...
        segments.forEach(segment ->
                assertThat(tokenizer.estimateTokenCountInText(segment.text())).isLessThanOrEqualTo(maxSegmentSize));
        assertThat(segments).containsExactly(
                textSegment(format("%s %s %s %s", s1, s2, s3, s4), metadata("index", "0").put("document", "0").put("startIndex", "0")),
                textSegment(format("%s %s %s %s", s5, s6, s7, s8), metadata("index", "1").put("document", "0").put("startIndex", "329")),
                textSegment(format("%s %s %s %s", s8, s9, s10, s11), metadata("index", "2").put("document", "0").put("startIndex", "550")),
                textSegment(format("%s\n\n%s %s %s %s", s11, s12, s13, s14, s15), metadata("index", "3").put("document", "0").put("startIndex", "743")),
                textSegment(format("%s %s %s %s", s15, s16, s17, s18), metadata("index", "4").put("document", "0").put("startIndex", "928")),
                textSegment(format("%s %s %s %s %s %s", s19, s20, s21, s22, s23, s24), metadata("index", "5").put("document", "0").put("startIndex", "1183")),
                textSegment(format("%s %s %s %s %s %s", s22, s23, s24, s25, s26, s27), metadata("index", "6").put("document", "0").put("startIndex", "1293")),
                textSegment(format("%s %s %s", s27, s28, s29), metadata("index", "7").put("document", "0").put("startIndex", "1454"))
        );
    }
    ...
    void should_split_sample_text_without_paragraphs() {
        ...
        segments.forEach(segment ->
                assertThat(tokenizer.estimateTokenCountInText(segment.text())).isLessThanOrEqualTo(maxSegmentSize));
        assertThat(segments).containsExactly(
                textSegment(segment1, metadata("index", "0").put("document", "0").put("startIndex", "0")),
                textSegment(segment2, metadata("index", "1").put("document", "0").put("startIndex", "447")),
                textSegment(segment3, metadata("index", "2").put("document", "0").put("startIndex", "841")),
                textSegment(segment4, metadata("index", "3").put("document", "0").put("startIndex", "1234"))
        );
    }
    ...
    void should_split_sample_text_without_paragraphs_with_small_overlap() {
        ...
        assertThat(segments).containsExactly(
                TextSegment.from(sentences(0, 5), Metadata.from("index", "0").put("document", "0").put("startIndex", "0")),
                TextSegment.from(sentences(5, 12), Metadata.from("index", "1").put("document", "0").put("startIndex", "402")),
                TextSegment.from(sentences(10, 16), Metadata.from("index", "2").put("document", "0").put("startIndex", "743")),
                TextSegment.from(sentences(15, 24), Metadata.from("index", "3").put("document", "0").put("startIndex", "985")),
                TextSegment.from(sentences(21, 28), Metadata.from("index", "4").put("document", "0").put("startIndex", "1294"))
        );
    ...
    void should_split_sample_text_without_paragraphs_with_big_overlap() {
        ...
        assertThat(segments).containsExactly(
                TextSegment.from(sentences(0, 5), Metadata.from("index", "0").put("document", "0").put("startIndex", "0")),
                TextSegment.from(sentences(1, 6), Metadata.from("index", "1").put("document", "0").put("startIndex", "87")),
                TextSegment.from(sentences(3, 8), Metadata.from("index", "2").put("document", "0").put("startIndex", "233")),
                // TODO fix chopped "Mrs."
                TextSegment.from(sentences(4, 10) + " Mrs.", Metadata.from("index", "3").put("document", "0").put("startIndex", "329")),
                TextSegment.from(sentences(5, 12), Metadata.from("index", "4").put("document", "0").put("startIndex", "402")),
                TextSegment.from(sentences(7, 15), Metadata.from("index", "5").put("document", "0").put("startIndex", "550")),
                TextSegment.from(sentences(9, 16), Metadata.from("index", "6").put("document", "0").put("startIndex", "697")),
                // TODO fix chopped s18
                // TODO splitter should prioritize progressing forward instead of maximizing overlap
                TextSegment.from(sentences(10, 16) + " " + sentences[17].replace(" countless tales.", ""), Metadata.from("index", "7").put("document", "0").put("startIndex", "743")),
                // TODO this segment should not be present, there is s14-s19 below
                TextSegment.from(sentences(13, 17), Metadata.from("index", "8").put("document", "0").put("startIndex", "841")),
                TextSegment.from(sentences(13, 18), Metadata.from("index", "9").put("document", "0").put("startIndex", "841")),
                TextSegment.from(sentences(14, 23), Metadata.from("index", "10").put("document", "0").put("startIndex", "927")),
                TextSegment.from(sentences(16, 24), Metadata.from("index", "11").put("document", "0").put("startIndex", "1017")),
                TextSegment.from(sentences(17, 26), Metadata.from("index", "12").put("document", "0").put("startIndex", "1071")),
                TextSegment.from(sentences(18, 28), Metadata.from("index", "13").put("document", "0").put("startIndex", "1182"))
        );
    ...
    void should_split_text_with_CRLF_line_endings() {
        ...
        // then
        assertThat(segments).containsExactly(
                TextSegment.from("Title", Metadata.from("index", "0").put("startIndex", "0")),
                TextSegment.from("Header 1\r\nText 1", Metadata.from("index", "1").put("startIndex", "6")),
                TextSegment.from("Header 2\r\nText 2", Metadata.from("index", "2").put("startIndex", "23"))
        );
    }
