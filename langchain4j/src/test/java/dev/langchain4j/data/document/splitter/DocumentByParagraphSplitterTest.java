...
class DocumentByParagraphSplitterTest {
    ...
    void should_split_into_segments_with_one_paragraph_per_segment(String separator) {
        ...
        Document document = Document.from(
                format(" %s %s %s ", firstParagraph, separator, secondParagraph), metadata("document", "0"));
        ...
        assertThat(segments)
                .containsExactly(
                        ...
                        textSegment(
                                secondParagraph,
                                metadata(MetadataKeys.INDEX, "1").put("document", "0")));
    }
    ...
    void should_split_into_segments_with_multiple_paragraphs_per_segment(String separator) {
        ...
        assertThat(firstParagraph + secondParagraph + thirdParagraph).hasSizeGreaterThan(maxSegmentSize);
        ...
        assertThat(segments)
                .containsExactly(
                        textSegment(
                                ...
                                metadata(MetadataKeys.INDEX, "0").put("document", "0")),
                        textSegment(
                                firstSentenceOfSecondParagraph,
                                metadata(MetadataKeys.INDEX, "1").put("document", "0")),
                        textSegment(
                                secondSentenceOfSecondParagraph,
                                metadata(MetadataKeys.INDEX, "2").put("document", "0")),
                        textSegment(
                                thirdParagraph,
    ...
    void should_split_sample_text_containing_multiple_paragraphs() {
        ...
        String p3 = "Mrs. Jenkins ran the shop. " + "A mystery in her own right. "
        ...
        String p4p1 = "One wet afternoon, Eli entered. " + "He was just a boy, lost in the vastness of the store. "
        ...
        String p4p2 = "Without grandeur or pretense, it beckoned. " + "And he listened.";
        assertThat(tokenCountEstimator.estimateTokenCountInText(p4p2)).isEqualTo(15);

        String p5 = "He read. " + "And read. " + "The world around him melted.";
        ...
        segments.forEach(segment -> assertThat(tokenCountEstimator.estimateTokenCountInText(segment.text()))
                .isLessThanOrEqualTo(maxSegmentSize));
        assertThat(segments)
                .containsExactly(
                        textSegment(p1, metadata(MetadataKeys.INDEX, "0").put("document", "0")),
                        textSegment(p2p1, metadata(MetadataKeys.INDEX, "1").put("document", "0")),
                        textSegment(p2p2, metadata(MetadataKeys.INDEX, "2").put("document", "0")),
                        textSegment(p3, metadata(MetadataKeys.INDEX, "3").put("document", "0")),
                        textSegment(p4p1, metadata(MetadataKeys.INDEX, "4").put("document", "0")),
                        textSegment(p4p2, metadata(MetadataKeys.INDEX, "5").put("document", "0")),
                        textSegment(
                                p5 + "\n\n" + p6,
                                metadata(MetadataKeys.INDEX, "6").put("document", "0")),
                        textSegment(p7, metadata(MetadataKeys.INDEX, "7").put("document", "0")));
    }
    ...
    void should_split_sample_text_containing_multiple_paragraphs_with_overlap() {
        ...
        DocumentSplitter splitter =
                new DocumentByParagraphSplitter(maxSegmentSize, maxOverlapSize, tokenCountEstimator);
        ...
        assertThat(segments)
                .containsExactly(
                        textSegment(
                                format("%s %s %s %s", s1, s2, s3, s4),
                                metadata(MetadataKeys.INDEX, "0").put("document", "0")),
                        textSegment(
                                format("%s %s %s %s", s5, s6, s7, s8),
                                metadata(MetadataKeys.INDEX, "1").put("document", "0")),
                        textSegment(
                                format("%s %s %s %s", s8, s9, s10, s11),
                                metadata(MetadataKeys.INDEX, "2").put("document", "0")),
                        textSegment(
                                format("%s\n\n%s %s %s %s", s11, s12, s13, s14, s15),
                                metadata(MetadataKeys.INDEX, "3").put("document", "0")),
                        textSegment(
                                format("%s %s %s %s", s15, s16, s17, s18),
                                metadata(MetadataKeys.INDEX, "4").put("document", "0")),
                        textSegment(
                                format("%s %s %s %s %s %s", s19, s20, s21, s22, s23, s24),
                                metadata(MetadataKeys.INDEX, "5").put("document", "0")),
                        textSegment(
                                format("%s %s %s %s %s %s", s22, s23, s24, s25, s26, s27),
                                metadata(MetadataKeys.INDEX, "6").put("document", "0")),
                        textSegment(
                                format("%s %s %s", s27, s28, s29),
                                metadata(MetadataKeys.INDEX, "7").put("document", "0")));
    }
    ...
    void should_split_sample_text_without_paragraphs() {
        ...
        String segment4 = "Without grandeur or pretense, it beckoned. " + "And he listened. "
                + "He read. "
                + "And read. "
        ...
        Document document =
                Document.from(format("%s %s %s %s", segment1, segment2, segment3, segment4), metadata("document", "0"));
        ...
        assertThat(segments)
                .containsExactly(
                        textSegment(segment1, metadata(MetadataKeys.INDEX, "0").put("document", "0")),
                        textSegment(segment2, metadata(MetadataKeys.INDEX, "1").put("document", "0")),
                        textSegment(segment3, metadata(MetadataKeys.INDEX, "2").put("document", "0")),
                        textSegment(segment4, metadata(MetadataKeys.INDEX, "3").put("document", "0")));
    }
    ...
    void should_split_sample_text_without_paragraphs_with_small_overlap() {
        ...
        assertThat(segments)
                .containsExactly(
                        TextSegment.from(
                                sentences(0, 5),
                                Metadata.from(MetadataKeys.INDEX, "0").put("document", "0")),
                        TextSegment.from(
                                sentences(5, 12),
                                Metadata.from(MetadataKeys.INDEX, "1").put("document", "0")),
                        TextSegment.from(
                                sentences(10, 16),
                                Metadata.from(MetadataKeys.INDEX, "2").put("document", "0")),
                        TextSegment.from(
                                sentences(15, 24),
                                Metadata.from(MetadataKeys.INDEX, "3").put("document", "0")),
                        TextSegment.from(
                                sentences(21, 28),
                                Metadata.from(MetadataKeys.INDEX, "4").put("document", "0")));

        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(5, 5)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(10, 12)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(15, 16)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(21, 24)))
                .isLessThanOrEqualTo(maxOverlapSize);
    }
    ...
    void should_split_sample_text_without_paragraphs_with_big_overlap() {
        ...
        assertThat(segments)
                .containsExactly(
                        ...
                        TextSegment.from(
                                sentences(7, 15),
                                Metadata.from(MetadataKeys.INDEX, "5").put("document", "0")),
                        TextSegment.from(
                                sentences(9, 16),
                                Metadata.from(MetadataKeys.INDEX, "6").put("document", "0")),
                        // TODO fix chopped s18
                        // TODO splitter should prioritize progressing forward instead of maximizing overlap
                        TextSegment.from(
                                sentences(10, 16) + " " + sentences[17].replace(" countless tales.", ""),
                                Metadata.from(MetadataKeys.INDEX, "7").put("document", "0")),
                        // TODO this segment should not be present, there is s14-s19 below
                        TextSegment.from(
                                sentences(13, 17),
                                Metadata.from(MetadataKeys.INDEX, "8").put("document", "0")),
                        TextSegment.from(
                                sentences(13, 18),
                                Metadata.from(MetadataKeys.INDEX, "9").put("document", "0")),
                        TextSegment.from(
                                sentences(14, 23),
                                Metadata.from(MetadataKeys.INDEX, "10").put("document", "0")),
                        TextSegment.from(
                                sentences(16, 24),
                                Metadata.from(MetadataKeys.INDEX, "11").put("document", "0")),
                        TextSegment.from(
                                sentences(17, 26),
                                Metadata.from(MetadataKeys.INDEX, "12").put("document", "0")),
                        TextSegment.from(
                                sentences(18, 28),
                                Metadata.from(MetadataKeys.INDEX, "13").put("document", "0")));

        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(1, 5)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(3, 6)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(4, 8)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(5, 10)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(7, 12)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(9, 15)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(10, 16)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(13, 16)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(13, 17)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(14, 18)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(16, 23)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(17, 24)))
                .isLessThanOrEqualTo(maxOverlapSize);
        assertThat(tokenCountEstimator.estimateTokenCountInText(sentences(18, 26)))
                .isLessThanOrEqualTo(maxOverlapSize);
    }
    ...
    void should_split_text_with_CRLF_line_endings() {
        ...
        assertThat(segments)
                .containsExactly(
                        TextSegment.from("Title", Metadata.from(MetadataKeys.INDEX, "0")),
                        TextSegment.from("Header 1\r\nText 1", Metadata.from(MetadataKeys.INDEX, "1")),
                        TextSegment.from("Header 2\r\nText 2", Metadata.from(MetadataKeys.INDEX, "2")));
    }
