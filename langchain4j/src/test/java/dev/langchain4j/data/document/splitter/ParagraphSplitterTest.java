...
//        );
//
//        DocumentSplitter splitter = new SplitJoinParagraphs(maxSegmentSize);
//
...
//        );
//
//        DocumentSplitter splitter = new SplitJoinParagraphs(maxSegmentSize, tokenizer);
//
//        List<TextSegment> segments = splitter.split(document);
//
//        segments.forEach(segment ->
...
//        );
//    }
////         TODO test splitters on real world html, doc, pdf
//
//    public static void main(String[] args) {
//
//
//        Document document = FileSystemDocumentLoader.loadDocument("C:\\dev\\ai\\test.docx");
//
////        DocumentSplitter splitter = new RegexSplitter("\n", "\n", 300, new OpenAiTokenizer("gpt-4"));
////        DocumentSplitter splitter = new SplitJoinParagraphs(200, new OpenAiTokenizer("gpt-4"));
//
////        List<TextSegment> segments = splitter.split(document);
