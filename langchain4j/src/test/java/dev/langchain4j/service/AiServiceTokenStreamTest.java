...
class AiServiceTokenStreamTest {
    ...
    void prepareMessages() {
        this.messagesToSend.add(dev.langchain4j.data.message.SystemMessage.from("A system message"));
    ...
    private AiServiceTokenStream setupAiServiceTokenStream() {
        ...
        AiServiceTokenStream tokenStream = new AiServiceTokenStream(messagesToSend, content, context, memoryId);
        return tokenStream;
    }
}
