...
class DefaultGuardrailServiceTests {
    @Test
    void noGuardrails() {
        var guardrailService = new DefaultGuardrailService(NoGuardrailAssistant.class);
    ...
    void classLevelGuardrails() {
        var guardrailService = new DefaultGuardrailService(ClassLevelAssistant.class);
    ...
    void methodLevelGuardrails() {
        var guardrailService = new DefaultGuardrailService(MethodLevelAssistant.class);
    ...
    void classAndMethodLevelGuardrails() {
        var guardrailService = new DefaultGuardrailService(ClassAndMethodLevelAssistant.class);
