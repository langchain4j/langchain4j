...
public class AzureCosmosDBNoSqlContentRetrieverIT {
    ...
    public AzureCosmosDBNoSqlContentRetrieverIT() {
        embeddingModel = AzureOpenAiEmbeddingModel.builder()
                ...
                contentRetrieverWithFullTextRank = createContentRetriever(
                                AzureCosmosDBSearchQueryType.FULL_TEXT_RANKING, TEXT_RANK_CONTAINER, 0);
        ...
        private AzureCosmosDBNoSqlContentRetriever createContentRetriever(
            ...
            switch (queryType) {
                ...
                case HYBRID -> builder
                        .cosmosVectorEmbeddingPolicy(getVectorEmbeddingPolicy(dimensions))
