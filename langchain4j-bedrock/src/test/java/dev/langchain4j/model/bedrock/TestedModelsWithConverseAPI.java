...
public final class TestedModelsWithConverseAPI {
    ...
    public static final StreamingChatLanguageModel STREAMING_AWS_NOVA_MICRO = BedrockStreamingChatModel.builder()
            .modelId("us.amazon.nova-micro-v1:0")
            .build();

    public static final ChatLanguageModel AWS_NOVA_LITE =
            BedrockChatModel.builder().modelId("us.amazon.nova-lite-v1:0").build();
    public static final StreamingChatLanguageModel STREAMING_AWS_NOVA_LITE = BedrockStreamingChatModel.builder()
            .modelId("us.amazon.nova-lite-v1:0")
            .build();

    public static final ChatLanguageModel AWS_NOVA_PRO =
            BedrockChatModel.builder().modelId("us.amazon.nova-pro-v1:0").build();
    public static final StreamingChatLanguageModel STREAMING_AWS_NOVA_PRO = BedrockStreamingChatModel.builder()
    ...
    public static final StreamingChatLanguageModel STREAMING_COHERE_COMMAND_R_PLUS = BedrockStreamingChatModel.builder()
    ...
    public static final StreamingChatLanguageModel STREAMING_AI_JAMBA_1_5_MINI = BedrockStreamingChatModel.builder()
