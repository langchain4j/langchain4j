...
public final class TestedModels {
    ...
    public static final ChatLanguageModel AWS_NOVA_PRO = BedrockChatModel.builder()
            .modelId("us.amazon.nova-pro-v1:0")
            .temperature(0.1f)
            .build();

    public static final ChatLanguageModel AWS_TITAN_TEXT_EXPRESS = BedrockChatModel.builder()
    ...
    public static final ChatLanguageModel COHERE_COMMAND_R_PLUS = BedrockChatModel.builder()
            .modelId("cohere.command-r-plus-v1:0")
            .temperature(0.1f)
            .build();

    public static final ChatLanguageModel AI_JAMBA_INSTRUCT = BedrockChatModel.builder()
