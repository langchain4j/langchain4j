...
class BedrockMessageConverter {
    ...
    static ContentBlock createToolResultBlock(ToolExecutionResultMessage toolResult) {
        ToolResultBlock.Builder resultBuilder = ToolResultBlock.builder().toolUseId(toolResult.id());
        if (toolResult.hasSingleText()) {
            resultBuilder.content(ToolResultContentBlock.builder()
            ...
            resultBuilder.content(contentBlocks);
        }
