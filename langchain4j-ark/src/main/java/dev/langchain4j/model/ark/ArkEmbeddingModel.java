...
public class ArkEmbeddingModel implements EmbeddingModel {
    ...
    @Builder
    public ArkEmbeddingModel(String apiKey, String model, Integer dimensions, String user, Integer maxRetries) {
    ...
    private Response<List<Embedding>> batchEmbedTexts(List<TextSegment> textSegments) {
        EmbeddingRequest embeddingRequest = EmbeddingRequest.builder()
                ...
                .build();
        EmbeddingResult embeddingResult = withRetry(() -> service.createEmbeddings(embeddingRequest), maxRetries);
        // shutdown service
