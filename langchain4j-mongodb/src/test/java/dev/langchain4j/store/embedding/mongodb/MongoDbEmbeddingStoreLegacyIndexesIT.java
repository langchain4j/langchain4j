...
class MongoDbEmbeddingStoreLegacyIndexesIT extends EmbeddingStoreIT {
    ...
    private MongoDbTestFixture initializeTestHelper() {
        ...
        MongoCollection<MongoDbDocument> collection =
                helper.getDatabase().getCollection(helper.getCollectionName(), MongoDbDocument.class);
        ...
        MongoDbTestFixture fixture =
                helper.initialize(builder -> builder.createIndex(false).indexName(indexName));
        return fixture;
    }
    ...
    static Document fromIndexMappingLegacyKnnVector(IndexMapping indexMapping) {
        ...
        if (metadataFields != null && !metadataFields.isEmpty()) {
            ...
            metadataFields.forEach(field -> metadataFieldDoc.append(field, new Document("type", "token")));
            fields.append(
                    "metadata",
                    new Document()
        ...
        return new Document("mappings", new Document().append("dynamic", false).append("fields", fields));
    }
}
