...
@Testcontainers
public class OracleEmbeddingStoreExternalContainer {
//    @Container
...
//            .withPassword(("testpwd"));
    ...
    public static void main(String args[]) throws SQLException {
         ...
         */
        EmbeddingWrapper romantic = EmbeddingWrapper.of("Roses were red, skies were blue");
        EmbeddingWrapper suspense = EmbeddingWrapper.of("The killer was hiding behind the door");
...
//        PreparedStatement st = cn.prepareStatement("insert into vector_test values (?, ?, ?, ?)");
//
//        st.setString(1, "key1");
//        st.setString(2, romantic.getContent());
//        st.setObject(3, null);
//        st.setObject(4, romantic.getEmbedding().vector(), OracleType.VECTOR);
//        st.addBatch();
//
//        st.setString(1, "key2");
//        st.setString(2, suspense.getContent());
//        st.setObject(3, null);
//        st.setObject(4, suspense.getEmbedding().vector(), OracleType.VECTOR);
//        st.addBatch();
//
//        st.executeBatch();
//        st.close();

        EmbeddingWrapper query = EmbeddingWrapper.of("Walking in the park on a sunny day watching the red roses");
        //EmbeddingWrapper query = EmbeddingWrapper.of("Getting inside the haunted house at midnight");
        PreparedStatement qst = cn.prepareStatement("select id, to_char(content), vector_distance(?, embedding, COSINE) * 100 from vector_test");
        qst.setObject(1, query.getEmbedding().vector(), OracleType.VECTOR);
