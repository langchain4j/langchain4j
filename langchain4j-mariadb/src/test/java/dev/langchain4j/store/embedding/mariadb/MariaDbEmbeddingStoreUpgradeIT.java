...
class MariaDbEmbeddingStoreUpgradeIT {
    ...
    void upgrade() {
        ...
        EmbeddingSearchResult<?> embeddingSearchResult =
                embeddingStore029.search(embeddingSearchRequest);
        ...
        EmbeddingSearchRequest embeddingSearchRequest2 =
                EmbeddingSearchRequest.builder()
                        .queryEmbedding(embedding)
                        .maxResults(10)
                        .minScore(0.0)
                        .build();
        EmbeddingSearchResult<?> embeddingSearchResult2 =
                embeddingStore.search(embeddingSearchRequest2);
