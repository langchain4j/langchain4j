...
@Testcontainers
class ChromaEmbeddingStoreRemovalV2IT extends EmbeddingStoreWithRemovalIT {

    @Container
    private static final ChromaDBContainer chroma = new ChromaDBContainer("chromadb/chroma:1.1.0");
