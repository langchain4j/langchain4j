...
public class WatsonxAiLoggingInterceptor implements Interceptor {

    private static final Logger log = LoggerFactory.getLogger(WatsonxAiLoggingInterceptor.class);
