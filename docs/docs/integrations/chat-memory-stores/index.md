...
| [Hazelcast (IMap)](https://github.com/langchain4j/langchain4j/blob/main/langchain4j-hazelcast/src/test/java/dev/langchain4j/store/memory/chat/hazelcast/HazelcastChatMemoryStoreIT.java)                     | ✅           |         |
| [Hazelcast (CPMap)](https://github.com/langchain4j/langchain4j/blob/main/langchain4j-hazelcast-enterprise/src/test/java/dev/langchain4j/store/memory/chat/hazelcast/HazelcastCPMapChatMemoryStoreIT.java)                     | ✅           |         |
