...
```implementation 'dev.langchain4j:langchain4j-pgvector:1.7.1-beta14'```
...
| `createExtensionVector` | Specifies whether to create the `pgvector` extension in the database. Useful for quick setup, however should be disabled in production-level environment not to require permissions.                                                                                                                                                                                                                                                                           | `true`         | Optional                                                                                                                                                                                                                                                                          |
...
EmbeddingStore<TextSegment> embeddingStore = PgVectorEmbeddingStore.builder()
        ...
        .createExtensionVector(true)                // Automatically create VECTOR extension in PostgreSQL database (may require additional permissions
