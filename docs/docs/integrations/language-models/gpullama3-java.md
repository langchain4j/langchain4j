...
implementation 'dev.langchain4j:langchain4j-gpu-llama3:1.16.0-beta26'
```
---
## Model Compatibility
...
```bash
target/gpullama3.java-example-1.16.0-beta26.jar
```
...
CP="target/gpullama3.java-example-1.16.0-beta26.jar:$(cat cp.txt)"
