...
implementation 'dev.langchain4j:langchain4j-gpu-llama3:1.11.9-beta19'
```
---
## Model Compatibility
...
```bash
target/gpullama3.java-example-1.11.9-beta19.jar
```
...
CP="target/gpullama3.java-example-1.11.9-beta19.jar:$(cat cp.txt)"
