...
implementation 'dev.langchain4j:langchain4j-gpu-llama3:1.20.1-beta30'
```
---
## Model Compatibility
...
```bash
target/gpullama3.java-example-1.20.1-beta30.jar
```
...
CP="target/gpullama3.java-example-1.20.1-beta30.jar:$(cat cp.txt)"
