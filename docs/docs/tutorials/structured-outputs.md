...
## JSON Schema
Some LLM providers (currently Amazon Bedrock, Azure OpenAI, Google AI Gemini, Mistral, DashScope, Ollama and OpenAI) allow
...
however:
  - Amazon Bedrock, Azure OpenAI, Mistral, DashScope, Ollama, OpenAI and OpenAI Official also allow `JsonRawSchema` as a root element
...
:::note
The `JsonRawSchema` is currently supported only by Amazon Bedrock, Azure OpenAI, Mistral, DashScope, Ollama, OpenAI, OpenAI Official and Google AI Gemini.
...
- It works only with supported Amazon Bedrock, Azure OpenAI, Google AI Gemini, Mistral, DashScope, Ollama and OpenAI models.
...
- [9] - This is required to enable the JSON Schema feature for [DashScope](/integrations/language-models/dashscope).
