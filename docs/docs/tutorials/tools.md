...
It is possible to mix statically and dynamically specified tools in the same AI Service invocation.
In this case static and dynamic tools are merged together.
