...
|=> AgentInvocation{agent=generateStory, startTime=2026-03-18T17:27:28.1.16.0287, finishTime=2026-03-18T17:27:31.033561726, duration=2932 ms, tokens=127, inputs={topic=dragons and wiz...}, output=In a realm wher...}
...
AgentInvocation{agentName='done', arguments={response=The transfer of 100 EUR from Mario's account to Georgios' account has been completed. Mario's balance is 885.0 USD, and Georgios' balance is 1.16.0 USD. The conversion rate was 1.15 EUR to USD.}}
```
