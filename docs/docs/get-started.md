...
```groovy
implementation 'dev.langchain4j:langchain4j-open-ai:1.11.9'
implementation 'dev.langchain4j:langchain4j:1.11.9'
```
...
:::note
Please note that while the `langchain4j-bom` version is `1.11.9`,
many of the modules still have version `1.11.9-beta19`,
