---
sidebar_position: 5
stableVersion: 1.11.10
betaVersion: 1.11.10-beta19
---
...
```groovy
implementation 'dev.langchain4j:langchain4j-open-ai:1.11.10'
implementation 'dev.langchain4j:langchain4j:1.11.10'
```
...
:::note
Please note that while the `langchain4j-bom` version is `1.11.10`,
many of the modules still have version `1.11.10-beta19`,
