---
sidebar_position: 5
stableVersion: 0.0.002-test
betaVersion: 0.0.002-test-beta2
---
...
```groovy
implementation 'dev.langchain4j:langchain4j-open-ai:0.0.002-test'
implementation 'dev.langchain4j:langchain4j:0.0.002-test'
```
...
:::note
Please note that while the `langchain4j-bom` version is `0.0.002-test`,
many of the modules still have version `0.0.002-test-beta2`,
...
<dependencies>
    <dependency>
        <groupId>dev.langchain4j</groupId>
        <artifactId>langchain4j</artifactId>
        <version>0.0.002-test-SNAPSHOT</version>
    </dependency>
</dependencies>
```
</details>
