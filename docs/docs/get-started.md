---
sidebar_position: 5
stableVersion: 1.20.1
betaVersion: 1.20.1-beta30
---
...
```groovy
implementation 'dev.langchain4j:langchain4j-open-ai:1.20.1'
implementation 'dev.langchain4j:langchain4j:1.20.1'
```
...
:::note
Please note that while the `langchain4j-bom` version is `1.20.1`,
many of the modules still have version `1.20.1-beta30`,
