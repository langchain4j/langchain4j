...
```groovy
implementation 'dev.langchain4j:langchain4j-open-ai:1.16.0'
implementation 'dev.langchain4j:langchain4j:1.16.0'
```
...
:::note
Please note that while the `langchain4j-bom` version is `1.16.0`,
many of the modules still have version `1.16.0-beta26`,
