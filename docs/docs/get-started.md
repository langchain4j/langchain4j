...
```groovy
implementation 'dev.langchain4j:langchain4j-open-ai:1.11.8'
...
:::note
Please note that while the `langchain4j-bom` version is `1.11.8`,
many of the modules still have version `1.11.8-beta19`,
