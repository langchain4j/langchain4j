...
@Testcontainers
class Db2HibernateEmbeddingStoreIT extends EmbeddingStoreWithFilteringIT {
    ...
    protected static Stream<Arguments> should_filter_by_metadata_override() {
        return EmbeddingStoreWithFilteringIT.should_filter_by_metadata()
                // DB2 seems to have trouble to extract a UUID as varbinary from a JSON payload
                // Disable until https://hibernate.atlassian.net/browse/HHH-20223 is fixed
