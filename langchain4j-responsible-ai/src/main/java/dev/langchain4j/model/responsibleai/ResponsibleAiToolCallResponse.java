...
public class ResponsibleAiToolCallResponse {
    ...
    public RailScore getRailScore() { return railScore; }
    public void setRailScore(RailScore railScore) { this.railScore = railScore; }

    public Policy getPolicy() { return policy; }
    public void setPolicy(Policy policy) { this.policy = policy; }

    public Map<String, DimensionScore> getDimensionScores() { return dimensionScores; }
    public void setDimensionScores(Map<String, DimensionScore> dimensionScores) { this.dimensionScores = dimensionScores; }

    public ContextSignals getContextSignals() { return contextSignals; }
    public void setContextSignals(ContextSignals contextSignals) { this.contextSignals = contextSignals; }
    ...
    public ToolCallResult getResult() {
        ...
        r.setExplanation(decisionReason != null ? decisionReason
                : (railScore != null ? railScore.getSummary() : null));
    ...
    public static class Policy {
        @JsonProperty("applied_rule") private String appliedRule;
        @JsonProperty("source") private String source;
        @JsonProperty("violated_dimensions") private List<String> violatedDimensions;
        ...
        public List<String> getViolatedDimensions() { return violatedDimensions; }
        public void setViolatedDimensions(List<String> v) { this.violatedDimensions = v; }
    }
    ...
    public static class ContextSignals {
        @JsonProperty("tool_risk_level") private String toolRiskLevel;
        @JsonProperty("surveillance_risk") private Boolean surveillanceRisk;
        @JsonProperty("high_stakes_domain") private Boolean highStakesDomain;

        public String getToolRiskLevel() { return toolRiskLevel; }
        public void setToolRiskLevel(String toolRiskLevel) { this.toolRiskLevel = toolRiskLevel; }
        public Boolean getSurveillanceRisk() { return surveillanceRisk; }
        public void setSurveillanceRisk(Boolean surveillanceRisk) { this.surveillanceRisk = surveillanceRisk; }
        public Boolean getHighStakesDomain() { return highStakesDomain; }
        public void setHighStakesDomain(Boolean highStakesDomain) { this.highStakesDomain = highStakesDomain; }
    }
