...
class VoyageAiMultimodalEmbeddingIT {

    // A small, stable public image of a cat.
    ...
    private final VoyageAiEmbeddingModel model = VoyageAiEmbeddingModel.builder()
            .apiKey(System.getenv("VOYAGE_API_KEY"))
            .modelName("voyage-multimodal-3.5")
            .logRequests(true)
            .logResponses(false)
            .build();
    ...
    void should_embed_text_and_image_into_the_same_space() {
        ...
        // cross-modal: the cat image should be closer to "a cat" than to an unrelated finance query
