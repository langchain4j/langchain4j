...
public class VearchRequestLoggingInterceptor implements Interceptor {

    private static final Logger log = LoggerFactory.getLogger(VearchRequestLoggingInterceptor.class);

    private static final Set<String> COMMON_SECRET_HEADERS = Set.of("Authorization");
