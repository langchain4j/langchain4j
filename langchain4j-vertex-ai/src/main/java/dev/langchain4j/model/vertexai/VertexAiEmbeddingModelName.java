...
public enum VertexAiEmbeddingModelName {
    ...
    TEXTEMBEDDING_MULTMODAL("multimodalembedding", 1408), // accepts 128, 256, 512 too
    TEXTEMBEDDING_004("text-embedding-004", 768),
    TEXTEMBEDDING_PREVIEW_0815("text-embedding-preview-0815", 768),
    TEXTEMBEDDING_MULTILINGUAL_002("text-multilingual-embedding-002", 768),
