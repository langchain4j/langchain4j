...
class McpToolUpdatesStreamableHttpLegacyIT extends McpToolUpdatesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpToolUpdatesStreamableHttpLegacyIT.class);
