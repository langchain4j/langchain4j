...
class McpPromptsStreamableHttpLegacyIT extends McpPromptsTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpPromptsStreamableHttpLegacyIT.class);
