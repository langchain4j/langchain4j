...
class McpLoggingStreamableHttpLegacyIT extends McpLoggingTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpLoggingStreamableHttpLegacyIT.class);
