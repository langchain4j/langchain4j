...
class McpToolsStreamableHttpLegacyIT extends McpToolsTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpToolsStreamableHttpLegacyIT.class);
