...
class McpResourcesStreamableHttpLegacyIT extends McpResourcesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpResourcesStreamableHttpLegacyIT.class);
