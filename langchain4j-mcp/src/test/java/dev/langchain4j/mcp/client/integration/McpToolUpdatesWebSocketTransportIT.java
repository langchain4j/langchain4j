...
class McpToolUpdatesWebSocketTransportIT extends McpToolUpdatesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpToolUpdatesWebSocketTransportIT.class);
