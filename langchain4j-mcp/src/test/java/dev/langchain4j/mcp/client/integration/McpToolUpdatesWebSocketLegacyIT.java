...
class McpToolUpdatesWebSocketLegacyIT extends McpToolUpdatesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpToolUpdatesWebSocketLegacyIT.class);
