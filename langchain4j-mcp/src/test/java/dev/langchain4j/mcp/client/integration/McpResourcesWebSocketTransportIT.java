...
class McpResourcesWebSocketTransportIT extends McpResourcesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpResourcesWebSocketTransportIT.class);
