...
class McpPromptsWebSocketTransportIT extends McpPromptsTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpPromptsWebSocketTransportIT.class);
