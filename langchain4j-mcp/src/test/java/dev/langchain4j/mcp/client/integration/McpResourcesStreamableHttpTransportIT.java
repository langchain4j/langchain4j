...
class McpResourcesStreamableHttpTransportIT extends McpResourcesTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpResourcesStreamableHttpTransportIT.class);
