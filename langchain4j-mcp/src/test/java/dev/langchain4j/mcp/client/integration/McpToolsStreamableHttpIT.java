...
class McpToolsStreamableHttpIT extends McpToolsTestBase {
    ...
    @Override
    protected void verifyCancellationReceived(dev.langchain4j.service.tool.ToolProviderResult toolProviderResult) {
        // notifications/cancelled is not supported in modern protocol
    }
}
