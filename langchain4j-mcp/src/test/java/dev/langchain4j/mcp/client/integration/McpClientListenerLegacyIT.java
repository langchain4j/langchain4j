...
public class McpClientListenerLegacyIT {
    ...
    @Test
    public void initializeCalledDuringInit() {
        // afterInitialize is fired during client build (initializeLegacy),
        // which happened in @BeforeAll. Verify it was invoked.
        assertThat(testListener.initializeAfterContext).isNotNull();
        assertThat(testListener.initializeAfterContext.message().method).isEqualTo(McpClientMethod.INITIALIZE);

        // afterServerDiscover should NOT be called for legacy protocol
        assertThat(testListener.serverDiscoverContext).isNull();
    }
