...
class McpLoggingStreamableHttpTransportIT extends McpLoggingTestBase {

    private static final Logger log = LoggerFactory.getLogger(McpLoggingStreamableHttpTransportIT.class);
