...
class LanguageModelSqlFilterBuilderIT {
    ...
    void should_filter_by_genre_and_year(ChatLanguageModel model) {
        ...
        // then
        assertThat(filter)
                .isEqualTo(metadataKey("genre")
                        .isEqualTo("drama")
                        .and(metadataKey("year")
                                .isEqualTo((long) LocalDate.now().getYear())));
    }
    ...
    void should_filter_by_year_range(ChatLanguageModel model) {
        ...
        assertThat(filter)
                .isIn(
                        ...
                        metadataKey("year")
                                .isGreaterThanOrEqualTo(1990L)
                                .and(metadataKey("year").isLessThan(2000L)));
    }
    ...
    void should_filter_by_year_using_arithmetics(ChatLanguageModel model) {
        ...
        // then
        assertThat(filter)
                .isEqualTo(metadataKey("year").isEqualTo((long) LocalDate.now().getYear() - 1));
    }
