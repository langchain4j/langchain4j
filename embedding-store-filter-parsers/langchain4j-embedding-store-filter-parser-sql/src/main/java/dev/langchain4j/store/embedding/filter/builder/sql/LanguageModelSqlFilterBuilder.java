...
public class LanguageModelSqlFilterBuilder {
    ...
    public static class LanguageModelSqlFilterBuilderBuilder {
        ...
        /**
         * Sets the {@link ChatModel} used to translate natural-language queries into SQL WHERE clauses.
         *
        ...
        /**
         * Sets the {@link TableDefinition} that describes the metadata schema as a virtual SQL table.
         * It is rendered as a {@code CREATE TABLE} statement and injected into the prompt context.
         *
        ...
        /**
         * Sets a custom {@link PromptTemplate} for the SQL generation prompt.
         * The template must contain {@code {{query}}} and {@code {{create_table_statement}}} variables.
         * Defaults to a built-in SQLCoder-optimized template when not set.
         *
        ...
        /**
         * Sets a custom {@link SqlFilterParser} to parse the SQL generated by the language model.
         * Defaults to a new {@link SqlFilterParser} instance when not set.
         *
         * @param sqlFilterParser the SQL filter parser
         * @return {@code this}
         */
        ...
        /**
         * Builds the {@link LanguageModelSqlFilterBuilder}.
         *
         * @return the configured {@link LanguageModelSqlFilterBuilder}
         */
