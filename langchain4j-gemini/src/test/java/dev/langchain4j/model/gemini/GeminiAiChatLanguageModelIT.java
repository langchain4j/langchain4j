...
import static dev.langchain4j.model.gemini.GeminiAiChatLanguageModel.pythonCodeExecution;
import static dev.langchain4j.model.gemini.GeminiHarmBlockThreshold.BLOCK_LOW_AND_ABOVE;
import static dev.langchain4j.model.gemini.GeminiHarmCategory.HARM_CATEGORY_HARASSMENT;
import static dev.langchain4j.model.gemini.GeminiHarmCategory.HARM_CATEGORY_HATE_SPEECH;
import static java.util.Collections.singletonList;
import static org.assertj.core.api.Assertions.assertThat;

@ExtendWith(RetryExtension.class)
public class GeminiAiChatLanguageModelIT {
    ...
    void should_answer_simple_question() {
        // given
        GeminiAiChatLanguageModel gemini = GeminiAiChatLanguageModel.builder()
        ...
        assertThat(text).containsIgnoringCase("neural network");
...
//                .build())
    ...
    void should_support_tool_config() {
        ...
        // given
        gemini = GeminiAiChatLanguageModel.builder()
            .apiKey(GEMINI_AI_KEY)
            .modelName("gemini-1.5-flash")
            .logRequestsAndResponses(true)
