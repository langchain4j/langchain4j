...
class MistralAiChatModelThinkingIT {
    ...
    void should_answer_correctly_with_reasoning_model(MistralAiChatModelName modelName) {
        ...
        // when
        String response = model.chat("What is the capital of Germany? Answer in one word.");
    ...
    void should_send_thinking_in_follow_up_request_when_sendThinking_is_true() {
        ...
        model.chat(userMessage("What is 6 times 7?"), previousAiMessage, userMessage("Are you sure?"));
    ...
    void should_send_thinking_with_tool_calls_when_sendThinking_is_true() {
        ...
        model.chat(userMessage("What's the weather in Munich?"), aiMessageWithToolCall, toolResult);
