...
public class MistralAiEmbeddingModel extends DimensionAwareEmbeddingModel {
    ...
    public static class MistralAiEmbeddingModelBuilder {
         ...
         * @return {@code this}.
         */
        public MistralAiEmbeddingModel.MistralAiEmbeddingModelBuilder baseUrl(final String baseUrl) {
         ...
         * @return {@code this}.
         */
        public MistralAiEmbeddingModel.MistralAiEmbeddingModelBuilder apiKey(final String apiKey) {
            this.apiKey = apiKey;
            return this;
        }
         ...
         * @return {@code this}.
         */
        public MistralAiEmbeddingModel.MistralAiEmbeddingModelBuilder timeout(final Duration timeout) {
         ...
         * @return {@code this}.
         */
        public MistralAiEmbeddingModel.MistralAiEmbeddingModelBuilder logRequests(final Boolean logRequests) {
         ...
         * @return {@code this}.
         */
        public MistralAiEmbeddingModel.MistralAiEmbeddingModelBuilder logResponses(final Boolean logResponses) {
         ...
         * @return {@code this}.
         */
        public MistralAiEmbeddingModel.MistralAiEmbeddingModelBuilder maxRetries(final Integer maxRetries) {
        ...
        public String toString() {
            return "MistralAiEmbeddingModel.MistralAiEmbeddingModelBuilder("
