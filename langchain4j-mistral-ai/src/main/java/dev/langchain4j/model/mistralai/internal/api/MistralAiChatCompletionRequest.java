...
public class MistralAiChatCompletionRequest {
    ...
    public MistralAiChatCompletionRequest(MistralAiChatCompletionRequestBuilder builder) {
    ...
    public String toString() {
        return "MistralAiChatCompletionRequest(" + "model=" + this.getModel() + ", messages=" + this.getMessages()
                        == null
                ? "0"
    ...
    public static class MistralAiChatCompletionRequestBuilder {
        ...
        @Override
        public String toString() {
            return "MistralAiChatCompletionRequestBuilder(" + "model=" + this.model + ", messages=" + this.messages
                            == null
                    ? "0"
                    : this.messages.size()
                            + ", temperature=" + this.temperature
