...
public class MistralAiModelPermission {
    ...
    public MistralAiModelPermission(String id, String object, Integer created, Boolean allowCreateEngine, 
            Boolean allowSampling, Boolean allowLogprobs, Boolean allowSearchIndices, Boolean allowView, 
            Boolean allowFineTuning, String organization, String group, Boolean isBlocking) {
        this.id = id;
        this.object = object;
        this.created = created;
        this.allowCreateEngine = allowCreateEngine;
