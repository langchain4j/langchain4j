...
public class ALL_MINILM_L6_V2_Q_EmbeddingModel extends AbstractInProcessEmbeddingModel {
    ...
    public ALL_MINILM_L6_V2_Q_EmbeddingModel() {
        if (MODEL == null) {
            synchronized (ALL_MINILM_L6_V2_Q_EmbeddingModel.class) {
                if (MODEL == null) {
                    InputStream modelInputStream = getClass().getResourceAsStream("/all-minilm-l6-v2-q.onnx");
