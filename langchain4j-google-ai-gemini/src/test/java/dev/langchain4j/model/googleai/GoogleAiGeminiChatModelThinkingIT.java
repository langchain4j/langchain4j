...
class GoogleAiGeminiChatModelThinkingIT {
    ...
    @Test
    void should_return_and_NOT_preserve_thinking() { // TODO name
    ...
    @Test
    void should_not_include_thoughts() { // TODO name TODO remove?

        // given
        boolean includeThoughts = false;

        GeminiThinkingConfig thinkingConfig = GeminiThinkingConfig.builder()
                .includeThoughts(includeThoughts) // TODO good name for generic?
                .thinkingBudget(20)
                .build();
        ...
        assertThat(aiMessage.text()).contains("20");
