...
import static dev.langchain4j.model.gemini.PartsAndContentsMapper.fromMessageToGContent;
import static dev.langchain4j.model.gemini.FinishReasonMapper.fromGFinishReasonToFinishReason;
import static dev.langchain4j.model.gemini.PartsAndContentsMapper.fromGPartsToAiMessage;
import static dev.langchain4j.model.gemini.SchemaMapper.fromJsonSchemaToGSchema;
import static java.util.Collections.emptyList;

@Experimental
public class GeminiAiChatLanguageModel implements ChatLanguageModel {
    ...
    @Builder
    public GeminiAiChatLanguageModel(String apiKey, String modelName,
    ...
    public static class GeminiAiChatLanguageModelBuilder {
        public GeminiAiChatLanguageModelBuilder toolConfig(GeminiMode mode, String... allowedFunctionNames) {
            this.toolConfig = new GeminiFunctionCallingConfig(mode, Arrays.asList(allowedFunctionNames));
            return this;
        }

        public GeminiAiChatLanguageModelBuilder responseSchema(JsonSchema schema) {
            this.responseMimeType = "application/json";
        ...
        public GeminiAiChatLanguageModelBuilder safetySettings(Map<GeminiHarmCategory, GeminiHarmBlockThreshold> safetySettingMap) {
