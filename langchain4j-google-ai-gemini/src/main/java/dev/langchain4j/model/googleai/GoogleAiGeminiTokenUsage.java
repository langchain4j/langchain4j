...
public class GoogleAiGeminiTokenUsage extends TokenUsage {
    ...
    private InputTokensDetails addInputTokenDetails(TokenUsage that) {
        if (that instanceof GoogleAiGeminiTokenUsage thatGoogleAiGeminiTokenUsage) {
            if (this.inputTokensDetails == null) {
                return thatGoogleAiGeminiTokenUsage.inputTokensDetails;
            } else if (thatGoogleAiGeminiTokenUsage.inputTokensDetails == null) {
                return this.inputTokensDetails;
            } else {
                return InputTokensDetails.builder()
                        .cachedTokens(sum(this.inputTokensDetails.cachedTokens, thatGoogleAiGeminiTokenUsage.inputTokensDetails.cachedTokens))
                        .build();
            }
        } else {
            return this.inputTokensDetails;
    ...
    private OutputTokensDetails addOutputTokensDetails(TokenUsage that) {
        if (that instanceof GoogleAiGeminiTokenUsage thatGoogleAiGeminiTokenUsage) {
            if (this.outputTokensDetails == null) {
                return thatGoogleAiGeminiTokenUsage.outputTokensDetails;
            } else if (thatGoogleAiGeminiTokenUsage.outputTokensDetails == null) {
                return this.outputTokensDetails;
            } else {
                return OutputTokensDetails.builder()
                        .reasoningTokens(sum(this.outputTokensDetails.reasoningTokens, thatGoogleAiGeminiTokenUsage.outputTokensDetails.reasoningTokens))
                        .build();
            }
        } else {
            return this.outputTokensDetails;
    ...
    public String toString() {
        return "GoogleAiGeminiTokenUsage {" +
    ...
    public static class InputTokensDetails {
        ...
        @Override
        public String toString() {
            return "GoogleAiGeminiTokenUsage.InputTokensDetails {" +
    ...
    public static class OutputTokensDetails {
        ...
        @Override
        public String toString() {
            return "GoogleAiGeminiTokenUsage.OutputTokensDetails {" +
