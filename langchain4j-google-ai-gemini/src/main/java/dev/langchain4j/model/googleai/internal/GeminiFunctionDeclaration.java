...
public class GeminiFunctionDeclaration {
    ...
    public String toString() {
        return "GeminiFunctionDeclaration(name=" + this.getName() + ", description=" + this.getDescription()
    ...
    public static class GeminiFunctionDeclarationBuilder {
        ...
        public String toString() {
            return "GeminiFunctionDeclaration.GeminiFunctionDeclarationBuilder(name=" + this.name + ", description="
                    + this.description + ", parameters=" + this.parameters + ")";
        }
    }
}
