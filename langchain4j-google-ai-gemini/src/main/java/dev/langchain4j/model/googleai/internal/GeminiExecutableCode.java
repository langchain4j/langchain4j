...
class GeminiExecutableCode {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$programmingLanguage == null
                ? other$programmingLanguage != null
                : !this$programmingLanguage.equals(other$programmingLanguage)) return false;
    ...
    public static class GeminiExecutableCodeBuilder {
        ...
        public String toString() {
            return "GeminiExecutableCode.GeminiExecutableCodeBuilder(programmingLanguage=" + this.programmingLanguage
                    + ", code=" + this.code + ")";
        }
    }
}
