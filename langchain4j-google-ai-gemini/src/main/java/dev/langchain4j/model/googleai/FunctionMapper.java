...
class FunctionMapper {
    ...
    static List<GeminiTool> fromToolSpecsAndServerToolsToGTools(
            List<ToolSpecification> specifications,
        ...
        GeminiTool serverTool = GeminiServerToolsMapper.toGeminiTool(GeminiServerToolsMapper.mergeServerTools(
                serverTools,
                allowCodeExecution,
                allowGoogleSearch,
                allowUrlContext,
        ...
        return fromToolSpecsToGTools(
                ...
                serverTool != null
                        && serverTool.googleMaps() != null
                        && serverTool.googleMaps().enableWidget());
    }
