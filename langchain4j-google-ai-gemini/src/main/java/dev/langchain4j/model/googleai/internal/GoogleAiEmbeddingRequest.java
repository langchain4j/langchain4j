...
public class GoogleAiEmbeddingRequest {
    ...
    @JsonCreator
    public GoogleAiEmbeddingRequest(
    ...
    public boolean equals(final Object o) {
        ...
        if (this$outputDimensionality == null
                ? other$outputDimensionality != null
                : !this$outputDimensionality.equals(other$outputDimensionality)) return false;
        return true;
    }
    ...
    public String toString() {
        return "GoogleAiEmbeddingRequest(model=" + this.getModel() + ", content=" + this.getContent() + ", taskType="
                + this.getTaskType() + ", title=" + this.getTitle() + ", outputDimensionality="
    ...
    public static class GoogleAiEmbeddingRequestBuilder {
        ...
        public GoogleAiEmbeddingRequest build() {
            return new GoogleAiEmbeddingRequest(
                    this.model, this.content, this.taskType, this.title, this.outputDimensionality);
        }

        public String toString() {
            return "GoogleAiEmbeddingRequest.GoogleAiEmbeddingRequestBuilder(model=" + this.model + ", content="
                    + this.content + ", taskType=" + this.taskType + ", title=" + this.title + ", outputDimensionality="
