...
class GeminiCitationSource {
    ...
    public String toString() {
        return "GeminiCitationSource(startIndex=" + this.getStartIndex() + ", endIndex=" + this.getEndIndex() + ", uri="
                + this.getUri() + ", license=" + this.getLicense() + ")";
    }
    ...
    public static class GeminiCitationSourceBuilder {
        ...
        public String toString() {
            return "GeminiCitationSource.GeminiCitationSourceBuilder(startIndex=" + this.startIndex + ", endIndex="
                    + this.endIndex + ", uri=" + this.uri + ", license=" + this.license + ")";
        }
    }
}
