...
public class GeminiGenerateContentRequest {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$safetySettings == null
                ? other$safetySettings != null
                : !this$safetySettings.equals(other$safetySettings)) return false;
        ...
        if (this$systemInstruction == null
                ? other$systemInstruction != null
                : !this$systemInstruction.equals(other$systemInstruction)) return false;
        ...
        if (this$generationConfig == null
                ? other$generationConfig != null
                : !this$generationConfig.equals(other$generationConfig)) return false;
    ...
    public String toString() {
        return "GeminiGenerateContentRequest(model=" + this.getModel() + ", contents=" + this.getContents() + ", tools="
                + this.getTools() + ", toolConfig=" + this.getToolConfig() + ", safetySettings="
                + this.getSafetySettings() + ", systemInstruction=" + this.getSystemInstruction()
                + ", generationConfig=" + this.getGenerationConfig() + ", cachedContent=" + this.getCachedContent()
                + ")";
    }
    ...
    public static class GeminiGenerateContentRequestBuilder {
        ...
        public String toString() {
            return "GeminiGenerateContentRequest.GeminiGenerateContentRequestBuilder(model=" + this.model
                    + ", contents=" + this.contents + ", tools=" + this.tools + ", toolConfig=" + this.toolConfig
                    + ", safetySettings=" + this.safetySettings + ", systemInstruction=" + this.systemInstruction
                    + ", generationConfig=" + this.generationConfig + ", cachedContent=" + this.cachedContent + ")";
        }
    }
}
