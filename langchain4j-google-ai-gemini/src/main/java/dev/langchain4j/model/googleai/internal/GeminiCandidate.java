...
public class GeminiCandidate {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$citationMetadata == null
                ? other$citationMetadata != null
                : !this$citationMetadata.equals(other$citationMetadata)) return false;
        ...
        if (this$groundingAttributions == null
                ? other$groundingAttributions != null
                : !this$groundingAttributions.equals(other$groundingAttributions)) return false;
    ...
    public String toString() {
        return "GeminiCandidate(content=" + this.getContent() + ", finishReason=" + this.getFinishReason()
                + ", safetySettings=" + this.getSafetySettings() + ", citationMetadata=" + this.getCitationMetadata()
                + ", tokenCount=" + this.getTokenCount() + ", groundingAttributions=" + this.getGroundingAttributions()
                + ", index=" + this.getIndex() + ")";
    }
    ...
    public static class GeminiCandidateBuilder {
        ...
        public String toString() {
            return "GeminiCandidate.GeminiCandidateBuilder(content=" + this.content + ", finishReason="
                    + this.finishReason + ", safetySettings=" + this.safetySettings + ", citationMetadata="
                    + this.citationMetadata + ", tokenCount=" + this.tokenCount + ", groundingAttributions="
                    + this.groundingAttributions + ", index=" + this.index + ")";
        }
    }
}
