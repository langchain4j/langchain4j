...
class GeminiAttributionSourceId {
    ...
    GeminiAttributionSourceId(
            @JsonProperty("groundingPassage") GeminiGroundingPassageId groundingPassage,
    ...
    public boolean equals(final Object o) {
        ...
        if (this$groundingPassage == null
                ? other$groundingPassage != null
                : !this$groundingPassage.equals(other$groundingPassage)) return false;
        ...
        if (this$semanticRetrieverChunk == null
                ? other$semanticRetrieverChunk != null
                : !this$semanticRetrieverChunk.equals(other$semanticRetrieverChunk)) return false;
        return true;
    }
    ...
    public String toString() {
        return "GeminiAttributionSourceId(groundingPassage=" + this.getGroundingPassage() + ", semanticRetrieverChunk="
                + this.getSemanticRetrieverChunk() + ")";
    }
    ...
    public static class GeminiAttributionSourceIdBuilder {
        ...
        public GeminiAttributionSourceIdBuilder semanticRetrieverChunk(
        ...
        public String toString() {
            return "GeminiAttributionSourceId.GeminiAttributionSourceIdBuilder(groundingPassage="
                    + this.groundingPassage + ", semanticRetrieverChunk=" + this.semanticRetrieverChunk + ")";
        }
    }
}
