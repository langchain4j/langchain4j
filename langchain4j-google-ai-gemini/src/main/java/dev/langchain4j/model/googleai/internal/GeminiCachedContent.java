...
class GeminiCachedContent {
    ...
    public String toString() {
        return "GeminiCachedContent(contents=" + this.getContents() + ", tools=" + this.getTools() + ", createTime="
                + this.getCreateTime() + ", updateTime=" + this.getUpdateTime() + ", usageMetadata="
                + this.getUsageMetadata() + ", expireTime=" + this.getExpireTime() + ", ttl=" + this.getTtl()
                + ", name=" + this.getName() + ", displayName=" + this.getDisplayName() + ", model=" + this.getModel()
                + ", systemInstruction=" + this.getSystemInstruction() + ", toolConfig=" + this.getToolConfig() + ")";
    }
    ...
    public static class GeminiCachedContentBuilder {
        ...
        public String toString() {
            return "GeminiCachedContent.GeminiCachedContentBuilder(contents=" + this.contents + ", tools=" + this.tools
                    + ", createTime=" + this.createTime + ", updateTime=" + this.updateTime + ", usageMetadata="
                    + this.usageMetadata + ", expireTime=" + this.expireTime + ", ttl=" + this.ttl + ", name="
                    + this.name + ", displayName=" + this.displayName + ", model=" + this.model + ", systemInstruction="
                    + this.systemInstruction + ", toolConfig=" + this.toolConfig + ")";
        }
    }
}
