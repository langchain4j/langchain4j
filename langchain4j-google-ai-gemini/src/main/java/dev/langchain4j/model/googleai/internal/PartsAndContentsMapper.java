...
import static dev.langchain4j.model.googleai.internal.FunctionMapper.toToolExecutionRequests;
...
@Internal
public final class PartsAndContentsMapper {
    ...
    public static AiMessage fromGPartsToAiMessage(
    ...
    public static List<GeminiContent> fromMessageToGContent(
