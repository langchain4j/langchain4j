...
class GeminiSafetyRating {
    ...
    public String toString() {
        return "GeminiSafetyRating(category=" + this.getCategory() + ", threshold=" + this.getThreshold() + ", blocked="
                + this.getBlocked() + ")";
    }
    ...
    public static class GeminiSafetyRatingBuilder {
        ...
        public String toString() {
            return "GeminiSafetyRating.GeminiSafetyRatingBuilder(category=" + this.category + ", threshold="
                    + this.threshold + ", blocked=" + this.blocked + ")";
        }
    }
}
