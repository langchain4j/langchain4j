...
public class GeminiCountTokensRequest {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$generateContentRequest == null
                ? other$generateContentRequest != null
                : !this$generateContentRequest.equals(other$generateContentRequest)) return false;
        return true;
    }
    ...
    public String toString() {
        return "GeminiCountTokensRequest(contents=" + this.getContents() + ", generateContentRequest="
                + this.getGenerateContentRequest() + ")";
    }
}
