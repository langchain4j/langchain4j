...
import static dev.langchain4j.model.googleai.internal.Json.fromJson;
...
public class GeminiService {
    ...
    public GeminiGenerateContentResponse generateContent(String modelName, GeminiGenerateContentRequest request) {
    ...
    public GeminiCountTokensResponse countTokens(String modelName, GeminiCountTokensRequest request) {
    ...
    public GoogleAiEmbeddingResponse embed(String modelName, GoogleAiEmbeddingRequest request) {
    ...
    public GoogleAiBatchEmbeddingResponse batchEmbed(String modelName, GoogleAiBatchEmbeddingRequest request) {
