...
public class GeminiUsageMetadata {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$promptTokenCount == null
                ? other$promptTokenCount != null
                : !this$promptTokenCount.equals(other$promptTokenCount)) return false;
        ...
        if (this$cachedContentTokenCount == null
                ? other$cachedContentTokenCount != null
                : !this$cachedContentTokenCount.equals(other$cachedContentTokenCount)) return false;
        ...
        if (this$candidatesTokenCount == null
                ? other$candidatesTokenCount != null
                : !this$candidatesTokenCount.equals(other$candidatesTokenCount)) return false;
        ...
        if (this$totalTokenCount == null
                ? other$totalTokenCount != null
                : !this$totalTokenCount.equals(other$totalTokenCount)) return false;
        return true;
    }
    ...
    public String toString() {
        return "GeminiUsageMetadata(promptTokenCount=" + this.getPromptTokenCount() + ", cachedContentTokenCount="
                + this.getCachedContentTokenCount() + ", candidatesTokenCount=" + this.getCandidatesTokenCount()
                + ", totalTokenCount=" + this.getTotalTokenCount() + ")";
    }
    ...
    public static class GeminiUsageMetadataBuilder {
        ...
        public String toString() {
            return "GeminiUsageMetadata.GeminiUsageMetadataBuilder(promptTokenCount=" + this.promptTokenCount
                    + ", cachedContentTokenCount=" + this.cachedContentTokenCount + ", candidatesTokenCount="
                    + this.candidatesTokenCount + ", totalTokenCount=" + this.totalTokenCount + ")";
        }
    }
}
