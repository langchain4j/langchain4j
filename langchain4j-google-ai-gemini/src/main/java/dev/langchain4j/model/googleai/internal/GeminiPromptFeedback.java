...
class GeminiPromptFeedback {
    ...
    GeminiPromptFeedback(
            @JsonProperty("blockReason") GeminiBlockReason blockReason,
    ...
    public String toString() {
        return "GeminiPromptFeedback(blockReason=" + this.getBlockReason() + ", safetyRatings="
                + this.getSafetyRatings() + ")";
    }
    ...
    public static class GeminiPromptFeedbackBuilder {
        ...
        public String toString() {
            return "GeminiPromptFeedback.GeminiPromptFeedbackBuilder(blockReason=" + this.blockReason
