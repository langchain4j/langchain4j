...
public class GeminiTool {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$functionDeclarations == null
                ? other$functionDeclarations != null
                : !this$functionDeclarations.equals(other$functionDeclarations)) return false;
    ...
    public String toString() {
        return "GeminiTool(functionDeclarations=" + this.getFunctionDeclarations() + ", codeExecution="
                + this.getCodeExecution() + ")";
    }
    ...
    public static class GeminiToolBuilder {
        ...
        public String toString() {
            return "GeminiTool.GeminiToolBuilder(functionDeclarations=" + this.functionDeclarations + ", codeExecution="
                    + this.codeExecution + ")";
        }
    }
}
