...
public sealed interface StreamingChatModelReply {
    /**
     * Represents a partial responses received from an AI language model during a streaming interaction.
     *
     ...
     *
     * @property partialResponse The partial responses, usually a single token, but might be more,
     *                           which is a part of the complete responses.
    ...
    /**
     * Represents a final completion responses received from the AI language model
     * during the streaming chat process.
     *
     * This data class encapsulates the complete responses, which typically contains
     * the final output of a model's reply in the context of a conversation.
     *
     * @property response The final chat responses generated by the model.
