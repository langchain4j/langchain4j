 ...
 * buffers, providing a balance between performance and resource usage. Depending on the
 * context, it can be used as a standard size to initialize or manage buffers in memory.
 */
public const val DEFAULT_BUFFER_CAPACITY = 16384;
 ...
 */
@JvmOverloads
public fun TokenStream.asReplyFlow(bufferCapacity: Int = DEFAULT_BUFFER_CAPACITY): Flow<StreamingChatModelReply> =
    flow {
        callbackFlow {
