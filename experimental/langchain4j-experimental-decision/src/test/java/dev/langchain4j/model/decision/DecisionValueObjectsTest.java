...
class DecisionValueObjectsTest {

    @Test
    void answer_equals_hashCode_and_toString_follow_value_semantics() {
        DecisionAnswer answer = new NoulAnswer(0.83);
        DecisionAnswer same = new NoulAnswer(0.83);
        DecisionAnswer differentNoul = new NoulAnswer(0.5);
        DecisionAnswer withConfidence = new NoulAnswer(0.83, 0.9, ConfidenceProvenance.PROVIDER_REPORTED, Map.of());
        DecisionAnswer choice = new ChoiceAnswer("billing", 0.9, ConfidenceProvenance.PROVIDER_REPORTED, Map.of());
        DecisionAnswer score = new ScoreAnswer(1.5, 0.6, ConfidenceProvenance.PROVIDER_REPORTED, Map.of());
    ...
    void request_equals_hashCode_and_toString_follow_value_semantics() {
        DecisionRequest request = sampleRequest();
        DecisionRequest same = sampleRequest();
        DecisionRequest otherParameters = DecisionRequest.builder()
                ...
                .parameters(DecisionRequestParameters.builder()
                        ...
                        .build())
                .build();
        DecisionRequest otherQuestions = DecisionRequest.builder()
                .state(Map.of("message", "hello"))
        ...
        assertThat(request)
                ...
                .isNotEqualTo(null);
        assertThat(request.toString()).contains("DecisionRequest").contains("greeting");
    }

    @Test
    void response_equals_hashCode_and_toString_follow_value_semantics() {
        DecisionResponse response = sampleResponse();
        DecisionResponse same = sampleResponse();
        DecisionResponse other = DecisionResponse.builder()
        ...
        assertThat(response.toString()).contains("DecisionResponse").contains("refund");
    }
    ...
    void parameters_equals_hashCode_and_toString_follow_value_semantics() {
        ...
        DecisionRequestParameters same =
                DecisionRequestParameters.builder().modelName("jev-latest").build();
        DecisionRequestParameters other =
        ...
        assertThat(parameters.toString())
                .contains("DefaultDecisionRequestParameters")
                .contains("jev-latest");
    }
    ...
    void map_based_builder_overloads_match_the_repeated_add_forms() {
        ...
        DecisionRequest fromMap = DecisionRequest.builder()
                .state(Map.of("message", "hello"))
                .questions(questions)
                .build();
        DecisionRequest repeated = DecisionRequest.builder()
                .state(Map.of("message", "hello"))
                .question("greeting", noulQuestion("Is this a greeting?"))
                .build();
        ...
        DecisionResponse responseFromMap =
                DecisionResponse.builder().answers(answers).build();
        DecisionResponse responseRepeated = DecisionResponse.builder()
    ...
    private DecisionResponse sampleResponse() {
        return DecisionResponse.builder().answer("refund", new NoulAnswer(0.83)).build();
    }
