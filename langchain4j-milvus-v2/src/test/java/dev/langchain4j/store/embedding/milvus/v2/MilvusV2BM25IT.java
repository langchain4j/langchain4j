...
class MilvusV2BM25IT implements WithAssertions {
    ...
    void setUp() {
        ...
        // sparseMode is BM25 in default, searchMode is HYBRID to enable BM25 sparse queries
    ...
    void should_index_text_and_search_with_query_string_bm25() {
        ...
        MilvusV2EmbeddingSearchRequest req = MilvusV2EmbeddingSearchRequest.milvusBuilder()
                .queryEmbedding(embeddingModel.embed("full-text search BM25").content())
                .query("full-text search BM25")
                .maxResults(5)
                .build();
