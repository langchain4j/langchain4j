...
class MilvusV2HybridSearchDemoTest implements WithAssertions {
    ...
    void should_perform_vector_search_like_docs_example() {
        ...
        List<Embedding> denseEmbeddings = Arrays.asList(
                embeddingModel.embed("What's the best way to start learning robotics?").content(),
                embeddingModel.embed("How do I learn a computer language like java?").content(),
                embeddingModel.embed("How can I get started to learn information security?").content(),
                embeddingModel.embed("What is Java programming? How To Learn Java Programming Language?").content(),
        ...
        embeddingStore.addAllHybrid(
                ...
                denseEmbeddings, sparseEmbeddings, textSegments);
    ...
    void should_perform_hybrid_search_like_docs_example() {
        ...
        List<Embedding> denseEmbeddings = Arrays.asList(
                embeddingModel.embed("What is the best way to start robotics? Which is the best development board?").content(),
                embeddingModel.embed("What is Java programming? How To Learn Java Programming Language?").content(),
                embeddingModel.embed("What's the best way to start learning robotics?").content(),
    ...
    void should_compare_vector_and_hybrid_search_results() {
        ...
        List<Embedding> denseEmbeddings = Arrays.asList(
                ...
                embeddingModel.embed("How can I learn computer security?").content(),
                embeddingModel.embed("What is the best way to start robotics? Which is the best development board?").content(),
                embeddingModel.embed("How can I learn to speak English fluently?").content(),
                embeddingModel.embed("What are the best ways to learn French?").content(),
                embeddingModel.embed("How can you make physics easy to learn?").content(),
                embeddingModel.embed("How do we prepare for UPSC?").content(),
                embeddingModel.embed("What is the alternative to machine learning?").content());
