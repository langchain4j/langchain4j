...
class MilvusV2EmbeddingStoreRemovalIT extends EmbeddingStoreWithRemovalIT {
    ...
    protected List<EmbeddingMatch<TextSegment>> getAllEmbeddings() {
        ...
        MilvusV2EmbeddingSearchRequest milvusV2EmbeddingSearchRequest = MilvusV2EmbeddingSearchRequest.milvusBuilder()
                .queryEmbedding(embeddingModel().embed("test").content())
                .maxResults(1000)
                .build();

        EmbeddingSearchResult<TextSegment> searchResult = embeddingStore().search(milvusV2EmbeddingSearchRequest);
