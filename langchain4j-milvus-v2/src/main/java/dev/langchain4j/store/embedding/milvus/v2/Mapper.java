...
import static dev.langchain4j.store.embedding.milvus.v2.CollectionOperationsExecutor.queryForVectors;
import static dev.langchain4j.store.embedding.milvus.v2.Generator.generateEmptyJsons;
import static dev.langchain4j.store.embedding.milvus.v2.Generator.generateEmptyScalars;
