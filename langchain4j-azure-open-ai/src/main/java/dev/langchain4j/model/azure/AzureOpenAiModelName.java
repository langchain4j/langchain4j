...
public class AzureOpenAiModelName {
    ...
    public static final String GPT_3_5_TURBO_INSTRUCT = "gpt-3.5-turbo-instruct"; // alias for the latest model
    public static final String GPT_3_5_TURBO_INSTRUCT_0914 = "gpt-3.5-turbo-instruct-0914"; // 4k context, functions
