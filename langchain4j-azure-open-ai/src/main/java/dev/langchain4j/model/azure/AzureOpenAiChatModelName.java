...
public enum AzureOpenAiChatModelName {
    ...
    GPT_3_5_TURBO("gpt-3.5-turbo"), // alias for the latest gpt-3.5-turbo model
    GPT_3_5_TURBO_0613("gpt-3.5-turbo-0613"), // 4k context, functions
    GPT_3_5_TURBO_1106("gpt-3.5-turbo-1106"), // 16k context, functions
    GPT_3_5_TURBO_0125("gpt-3.5-turbo-0125"), // 4k context, functions

    GPT_3_5_TURBO_16K("gpt-3.5-turbo-16k"), // alias for the latest gpt-3.5-turbo-16k model
    GPT_3_5_TURBO_16K_0613("gpt-3.5-turbo-16k-0613"), // 16k context, functions
