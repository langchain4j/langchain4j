...
public class AgenticScopeSerializer {
     ...
     * deserialization in the JVM and cannot be removed. Registration is not retroactive:
     * a type must be allowed before the {@link #fromJson(String)} call that encounters it,
     * otherwise that call fails with {@link UnserializableAgenticScopeException}.
     *
