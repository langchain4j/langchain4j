...
public enum WorkflowAgentsBuilderImpl implements WorkflowAgentsBuilder {
    ...
    @Override
    public ConditionialAgentService<UntypedAgent> conditionalBuilder() {
        return ConditionialAgentServiceImpl.builder();
    }

    @Override
    public <T> ConditionialAgentService<T> conditionalBuilder(final Class<T> agentServiceClass) {
        return ConditionialAgentServiceImpl.builder(agentServiceClass);
    }
}
