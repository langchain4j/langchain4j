...
public class GuardedAgentServices<T> {
    ...
    private GuardedAgentServices(Class<T> agentServiceClass) {
        this.agentServiceClass = agentServiceClass;
        this.context = new AiServiceContext(agentServiceClass);
        this.aiServices = AiServices.builder(context);
    }

    public static <T> GuardedAgentServices<T> builder(Class<T> agentServiceClass) {
        return new GuardedAgentServices<>(agentServiceClass);
    }
    ...
    public GuardedAgentServices<T> chatModel(ChatModel model) {
        aiServices.chatModel(model);
        return this;
    }

    public GuardedAgentServices<T> chatState(ChatState chatState) {
        aiServices.chatMemory(chatState);
        return this;
    }

    public GuardedAgentServices<T> tools(Object... objectsWithTools) {
        aiServices.tools(objectsWithTools);
        return this;
    }

    public GuardedAgentServices<T> agents(Object... agents) {
    ...
    public GuardedAgentServices<T> onRequest(Function<AgentRequest, AgentDirective> onRequest) {
        this.onRequest = onRequest;
        return this;
    }

    public GuardedAgentServices<T> onResponse(Function<AgentResponse, AgentDirective> onResponse) {
        this.onResponse = onResponse;
        return this;
    }

    public GuardedAgentServices<T> outputName(String outputName) {
