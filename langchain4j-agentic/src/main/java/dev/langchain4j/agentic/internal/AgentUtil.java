...
public class AgentUtil {
    ...
    public static AgentExecutor agentToExecutor(Object agent) {
        ...
        AgentInvoker agentInvoker = agent instanceof AgentSpecsProvider spec ?
                new MethodAgentInvoker(agenticMethod, name, spec.description(), spec.outputName(), spec.nonBlocking(),
                        List.of(new AgentArgument(agenticMethod.getParameterTypes()[0], spec.inputName()))) :
                AgentInvoker.fromMethodAndSpec(agenticMethod, name, description, annotation.outputName(), annotation.nonBlocking());
