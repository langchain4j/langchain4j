...
public class SupervisorAgentIT {
    ...
    void agents_system_test() {
        ...
        SupervisorAgent askToExpert = SupervisorAgentService.builder(PLANNER_MODEL)
    ...
    void agentic_banker_test() {
        ...
        BankerAgent bankerAgent = AgentServices.agentBuilder(BankerAgent.class)
                .chatModel(BASE_MODEL)
                .tools(bankTool)
                .build();
    ...
    void agentic_banker_with_exchange_test() {
        ...
        ExchangeAgent exchangeAgent = AgentServices.agentBuilder(ExchangeAgent.class)
                .chatModel(BASE_MODEL)
