...
public class DependencyGraphSearch {
     ...
     */
    private record SearchState(Set<Node> activatedNodes, Node currentNode, int depth) {
        private SearchState(Set<Node> activatedNodes, Node currentNode, int depth) {
            this.activatedNodes = new HashSet<>(activatedNodes);
     ...
     */
    private record StateScore(SearchState state, double fScore) implements Comparable<StateScore> {
