...
import com.example.GuardrailValidation;
...
class InputGuardrailPromptTemplateTests {
    @BeforeEach
    void beforeEach() {
        GuardrailValidation.getInstance().reset();
    }
    ...
    void shouldWorkNoParameters(String testDescription, Assistant aiService) {
        ...
        assertThat(GuardrailValidation.getInstance().spyUserMessageTemplate()).isEqualTo("Tell me a joke");
        assertThat(GuardrailValidation.getInstance().spyVariables()).isEmpty();
    }
    ...
    void shouldWorkWithMemoryId(String testDescription, Assistant aiService) {
        ...
        assertThat(GuardrailValidation.getInstance().spyUserMessageTemplate()).isEqualTo("Tell me another joke");
        assertThat(GuardrailValidation.getInstance().spyVariables())
    ...
    void shouldWorkWithNoMemoryIdAndOneParameter(String testDescription, Assistant aiService) {
        ...
        assertThat(GuardrailValidation.getInstance().spyUserMessageTemplate()).isEqualTo("Say hi to my friend {{it}}!");
        assertThat(GuardrailValidation.getInstance().spyVariables())
    ...
    void shouldWorkWithMemoryIdAndOneParameter(String testDescription, Assistant aiService) {
        ...
        assertThat(GuardrailValidation.getInstance().spyUserMessageTemplate())
    ...
    void shouldWorkWithNoMemoryIdAndList(String testDescription, Assistant aiService) {
        ...
        assertThat(GuardrailValidation.getInstance().spyUserMessageText())
    ...
    interface Assistant {
        ...
        static Assistant create() {
            return AiServices.builder(Assistant.class)
                    .chatLanguageModel(new MyChatModel())
                    .chatMemoryProvider(memoryId -> MessageWindowChatMemory.withMaxMessages(10))
                    .inputGuardrails(List.of(GuardrailValidation.getInstance()))
                    .build();
        }
    }
