...
public class OpenAiOfficialResponsesStreamingChatModel implements StreamingChatModel {
    ...
    public static class Builder {
        ...
        /**
         * Controls whether obfuscated (encrypted) reasoning tokens are included in the stream.
         *
         * @param streamIncludeObfuscation {@code true} to include obfuscated reasoning in the stream
         * @return {@code this}
         */
        ...
        /**
         * Sets a custom {@link ExecutorService} used to run streaming callbacks off the HTTP thread.
         *
