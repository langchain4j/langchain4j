...
class OpenAiOfficialStreamingChatModelIT extends AbstractStreamingChatModelIT {
    ...
    static final OpenAiOfficialStreamingChatModel OPEN_AI_CHAT_MODEL = OpenAiOfficialStreamingChatModel.builder()
    ...
    static final OpenAiOfficialStreamingChatModel OPEN_AI_CHAT_MODEL_STRICT_SCHEMA = OpenAiOfficialStreamingChatModel.builder()
            .baseUrl(System.getenv("AZURE_OPENAI_ENDPOINT"))
            .azureApiKey(System.getenv("AZURE_OPENAI_KEY"))
            .azureOpenAIServiceVersion(API_VERSION)
            .modelName(MODEL_NAME)
    ...
    protected StreamingChatLanguageModel createModelWith(ChatRequestParameters parameters) {
        OpenAiOfficialStreamingChatModel.OpenAiOfficialStreamingChatModelBuilder openAiChatModelBuilder = OpenAiOfficialStreamingChatModel.builder()
                .baseUrl(System.getenv("AZURE_OPENAI_ENDPOINT"))
                .azureApiKey(System.getenv("AZURE_OPENAI_KEY"))
