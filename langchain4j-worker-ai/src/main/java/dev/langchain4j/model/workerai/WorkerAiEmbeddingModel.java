...
import dev.langchain4j.model.workerai.client.WorkerAiEmbeddingRequest;
import dev.langchain4j.model.workerai.client.WorkerAiEmbeddingResponse;
 ...
 */
@Slf4j
public class WorkerAiEmbeddingModel extends AbstractWorkerAIModel implements EmbeddingModel {
     ...
     *      builder.
     */
    public WorkerAiEmbeddingModel(WorkerAiModelBuilder builder) {
        super(builder);
    }
    ...
    public WorkerAiEmbeddingModel(String accountIdentifier, String modelName, String token) {
    ...
    public Response<Embedding> embed(String text) {
        try {
            WorkerAiEmbeddingRequest req = new WorkerAiEmbeddingRequest();
            req.getText().add(text);

            retrofit2.Response<WorkerAiEmbeddingResponse> retrofitResponse = workerAiClient
            ...
            WorkerAiEmbeddingResponse.EmbeddingResult res = retrofitResponse.body().getResult();
