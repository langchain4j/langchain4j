...
import dev.langchain4j.model.wenxin.client.Usage;
...
public final class ChatCompletionResponse {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(id, that.id).append(errorCode, that.errorCode)
                ...
                .append(ban_round, that.ban_round).append(usage, that.usage).append(function_call, that.function_call).append(finish_reason, that.finish_reason)
                .isEquals();
    }
    ...
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(id).append(errorCode).append(errorMsg).append(object).append(created)
                ...
                .append(ban_round).append(usage).append(function_call).append(finish_reason).toHashCode();
    }
