...
/**
 * Metadata filtering tests for halfvec using {@link MetadataStorageMode#COLUMN_PER_KEY}.
 * Each metadata key is stored in its own typed column.
 */
@Testcontainers
class PgVectorHalfVecWithColumnsFilteringIT extends PgVectorEmbeddingStoreHalfVecConfigIT {
