...
- Deferred async tool execution in streaming — tools are submitted to the executor after `intermediateResponseHandler` fires, ensuring intermediate text is delivered before tool execution events (`d763dd1`).
