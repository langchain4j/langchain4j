 ...
 * {@link OpenAiPromptCacheBreakpoint breakpoint}, without falling back to a shorter unmarked prefix.
 ...
 *     {@link OpenAiPromptCacheBreakpoint} are used. Without any breakpoint, nothing is cached.</li>
 * </ul>
 * <p>
 ...
 * @since 1.20.0
 */
public class OpenAiPromptCacheOptions {
     ...
     *
     * @see OpenAiPromptCacheBreakpoint
     */
    ...
    private OpenAiPromptCacheOptions(Builder builder) {
     ...
     */
    public static OpenAiPromptCacheOptions implicit() {
     ...
     */
    public static OpenAiPromptCacheOptions explicit() {
    ...
    public boolean equals(Object o) {
        ...
        OpenAiPromptCacheOptions that = (OpenAiPromptCacheOptions) o;
    ...
    public String toString() {
        return "OpenAiPromptCacheOptions{" + "mode=" + quoted(mode) + ", ttl=" + quoted(ttl) + '}';
    }
    ...
    public static class Builder {
        ...
        public OpenAiPromptCacheOptions build() {
            return new OpenAiPromptCacheOptions(this);
        }
    }
}
