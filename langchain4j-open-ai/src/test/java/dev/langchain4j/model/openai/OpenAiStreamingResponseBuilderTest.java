...
class OpenAiStreamingResponseBuilderTest {
    ...
    void should_handle_negative_tool_call_index() {
        // Given: a tool call with index -1 (as some OpenAI-compatible proxies return
        // when translating from Anthropic's content-block-indexed format)
        OpenAiStreamingResponseBuilder builder = new OpenAiStreamingResponseBuilder();
    ...
    @Test
    void should_handle_multiple_tool_calls_with_negative_index() {
        // Given: two distinct tool calls, both with negative index
        OpenAiStreamingResponseBuilder builder = new OpenAiStreamingResponseBuilder();
