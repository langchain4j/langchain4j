...
import static dev.langchain4j.model.openai.OpenAiChatModelName.GPT_5_2025_08_07;
import static dev.langchain4j.model.openai.OpenAiChatModelName.GPT_5_CHAT_LATEST;
import static dev.langchain4j.model.openai.OpenAiChatModelName.GPT_5_MINI;
import static dev.langchain4j.model.openai.OpenAiChatModelName.GPT_5_MINI_2025_08_07;
import static dev.langchain4j.model.openai.OpenAiChatModelName.GPT_5_NANO;
import static dev.langchain4j.model.openai.OpenAiChatModelName.GPT_5_NANO_2025_08_07;
...
class OpenAiTokenCountEstimatorIT {
    ...
    void should_count_tokens_in_messages(List<ChatMessage> messages, OpenAiChatModelName modelName) {
        ...
        OpenAiChatModel model = OpenAiChatModel.builder()
                ...
                .modelName(modelName)
                .maxCompletionTokens(
                        modelName.toString().startsWith("o") ? 100 : 1) // we don't need outputs, let's not waste tokens
                .logRequests(true)
                .logResponses(true)
                .build();
    ...
    void should_count_tokens_in_messages_with_multiple_tools(
            List<ChatMessage> messages, OpenAiChatModelName modelName) {
        // given
        OpenAiChatModel model = OpenAiChatModel.builder()
                .baseUrl(System.getenv("OPENAI_BASE_URL"))
                .apiKey(System.getenv("OPENAI_API_KEY"))
