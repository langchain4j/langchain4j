...
public abstract class EmbeddingStoreWithFilteringIT extends EmbeddingStoreIT {
    ...
    protected void should_filter_by_metadata(
        ...
        shouldFilter(metadataFilter, matchingMetadatas, notMatchingMetadatas);
    }
        ...
        return Stream
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", "a"), new Metadata().put("key", "a").put("key2", "b")),
                    asList(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", TEST_UUID), new Metadata().put("key", TEST_UUID).put("key2", "b")),
                    asList(new Metadata().put("key", UUID.randomUUID()), new Metadata().put("key2", TEST_UUID))
                )
            )
            .add(
                Arguments.of(
                    metadataKey("key").isEqualTo(1),
                    asList(new Metadata().put("key", 1), new Metadata().put("key", 1).put("key2", 0)),
                    asList(new Metadata().put("key", -1), new Metadata().put("key", 0), new Metadata().put("key2", 1))
                )
            )
            .add(
                Arguments.of(
                    metadataKey("key").isEqualTo(1L),
                    asList(new Metadata().put("key", 1L), new Metadata().put("key", 1L).put("key2", 0L)),
                    asList(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 1.23f), new Metadata().put("key", 1.23f).put("key2", 0f)),
                    asList(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 1.23d), new Metadata().put("key", 1.23d).put("key2", 0d)),
                    asList(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 2), new Metadata().put("key", 2).put("key2", 0)),
                    asList(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 2L), new Metadata().put("key", 2L).put("key2", 0L)),
                    asList(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 1.2f), new Metadata().put("key", 1.2f).put("key2", 1.0f)),
                    asList(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 1.2d), new Metadata().put("key", 1.2d).put("key2", 1.0d)),
                    asList(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 1), new Metadata().put("key", 2), new Metadata().put("key2", 0))
                )
            )
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 1L), new Metadata().put("key", 2L), new Metadata().put("key2", 0L))
                )
            )
            .add(
                Arguments.of(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("name", "Klaus"), new Metadata().put("name", "Klaus").put("age", 42)),
                    asList(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("name", TEST_UUID), new Metadata().put("name", TEST_UUID).put("age", 42)),
                    asList(new Metadata().put("name", UUID.randomUUID()), new Metadata().put("name2", TEST_UUID))
                )
            )
            .add(
                Arguments.of(
            ...
            .add(
                Arguments.of(
                    or(metadataKey("name").isEqualTo("Klaus"), metadataKey("name").isEqualTo("Alice")),
                    asList(
                        new Metadata().put("name", "Klaus"),
                        new Metadata().put("name", "Klaus").put("age", 42),
                        new Metadata().put("name", "Alice"),
            ...
            .add(
                Arguments.of(
                    or(metadataKey("name").isEqualTo("Alice"), metadataKey("name").isEqualTo("Klaus")),
                    asList(
                        new Metadata().put("name", "Alice"),
                        new Metadata().put("name", "Alice").put("age", 42),
                        new Metadata().put("name", "Klaus"),
            ...
            .add(
                Arguments.of(
                    or(metadataKey("name").isEqualTo("Klaus"), metadataKey("age").isEqualTo(42)),
                    asList(
            ...
            .add(
                Arguments.of(
                    or(
                        ...
                        or(metadataKey("age").isEqualTo(42), metadataKey("city").isEqualTo("Munich"))
                    ),
                    asList(
                        // only Or.left is present and true
                        new Metadata().put("name", "Klaus"),
            ...
            .add(
                Arguments.of(
                    and(metadataKey("name").isEqualTo("Klaus"), metadataKey("age").isEqualTo(42)),
                    asList(
                        new Metadata().put("name", "Klaus").put("age", 42),
                        new Metadata().put("name", "Klaus").put("age", 42).put("city", "Munich")
                    ),
            ...
            .add(
                Arguments.of(
                    and(metadataKey("age").isEqualTo(42), metadataKey("name").isEqualTo("Klaus")),
                    asList(
                        new Metadata().put("name", "Klaus").put("age", 42),
                        new Metadata().put("name", "Klaus").put("age", 42).put("city", "Munich")
                    ),
            ...
            .add(
                Arguments.of(
                    and(
                        metadataKey("name").isEqualTo("Klaus"),
                        and(metadataKey("age").isEqualTo(42), metadataKey("city").isEqualTo("Munich"))
                    ),
                    asList(
                        new Metadata().put("name", "Klaus").put("age", 42).put("city", "Munich"),
                        new Metadata()
    ...
    static Stream<Arguments> should_filter_by_greater_and_less_than_alphanumeric_metadata() {
        return Stream
            .<Arguments>builder()
            // === GreaterThan ==
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", "c"), new Metadata().put("key", "c").put("key2", "a")),
                    asList(
                        new Metadata().put("key", "a"),
                        new Metadata().put("key", "b"),
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", "a"), new Metadata().put("key", "a").put("key2", "c")),
                    asList(
                        new Metadata().put("key", "b"),
                        new Metadata().put("key", "c"),
                        new Metadata().put("key2", "a")
    ...
    private void shouldFilter(
        ...
        Embedding notMatchingEmbeddingWithoutMetadata = embeddingModel()
            .embed(notMatchingSegmentWithoutMetadata)
            .content();
    ...
    protected void should_filter_by_metadata_not(
        ...
        List<Metadata> matchingMetadatas,
        List<Metadata> notMatchingMetadatas,
        boolean buildSegmentWithoutMetadata
    ) {
        // given
        List<Embedding> embeddings = new ArrayList<>();
        List<TextSegment> segments = new ArrayList<>();
        ...
        if (buildSegmentWithoutMetadata) {
        ...
        assertThat(embeddingStore().findRelevant(queryEmbedding, 100))
            .hasSize(matchingMetadatas.size() + notMatchingMetadatas.size() + (buildSegmentWithoutMetadata ? 1 : 0));
        ...
        // then
        assertThat(matches).hasSize(matchingMetadatas.size() + (buildSegmentWithoutMetadata ? 1 : 0));
        matches.forEach(match -> assertThat(match.embedded().text()).isEqualTo("matching"));
        matches.forEach(match -> assertThat(match.score()).isCloseTo(1, withPercentage(0.01)));
    }
        ...
        return Stream
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 1), new Metadata().put("key", 1).put("key2", 2)),
                    true
                )
            )
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 1L), new Metadata().put("key", 1L).put("key2", 2L)),
                    true
                )
            )
            .add(
            ...
            .add(
                Arguments.of(
                    ...
                    asList(new Metadata().put("key", 1.1), new Metadata().put("key", 1.1).put("key2", 2.2)),
                    true
                )
            )
            // === NotIn ===
