...
class LazyJsonStringBenchmarkTest {
    ...
    void demonstrateOnDemandEvaluation() {
        ...
        System.out.println("Creation of 100 LazyJsonString objects: " + 
                          TimeUnit.NANOSECONDS.toMicros(creationTime) + " μs");
        System.out.println("Computation of 10 objects: " + 
                          TimeUnit.NANOSECONDS.toMicros(partialComputationTime) + " μs");
