...
/**
 * A listener for {@link LLMInteractionStartedEvent}, which represents an event
 ...
 */
@FunctionalInterface
public interface LLMInteractionStartedEventListener extends LLMInteractionEventListener<LLMInteractionStartedEvent> {
    @Override
    default Class<LLMInteractionStartedEvent> getEventClass() {
