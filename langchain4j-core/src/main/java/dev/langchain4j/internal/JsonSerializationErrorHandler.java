...
public final class JsonSerializationErrorHandler {
     ...
     */
    public static String handleSupplierError(Exception supplierException, java.util.function.Supplier<Object> fallbackSupplier) {
        ...
        if (fallbackSupplier != null) {
            try {
                ...
                log.error(MULTIPLE_FAILURES_ERROR + " - Original: {}, Fallback: {}", 
                         supplierException.getMessage(), fallbackException.getMessage(), fallbackException);
    ...
    public static String handleJsonSerializationError(Exception serializationException, Object originalValue) {
        log.warn(JSON_SERIALIZATION_ERROR + " for object of type {}: {}", 
                originalValue != null ? originalValue.getClass().getSimpleName() : "null",
                serializationException.getMessage(), serializationException);
    ...
    public static String handleToStringFallback(Object value) {
        ...
        try {
            ...
            log.debug("Successfully used toString() fallback for object of type {}", value.getClass().getSimpleName());
            return result;
        } catch (Exception toStringException) {
            log.error(FALLBACK_SERIALIZATION_ERROR + " for object of type {}: {}", 
                     value.getClass().getSimpleName(), toStringException.getMessage(), toStringException);
    ...
    public static String createErrorMessage(Exception exception) {
        return String.format("LazyEvaluation Error: %s - %s", 
    ...
    public static String createErrorMessage(Exception primaryException, Exception fallbackException) {
        return String.format("LazyEvaluation Multiple Errors: Primary[%s: %s], Fallback[%s: %s]",
