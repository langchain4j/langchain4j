...
public class Utils {
     ...
     */
    public static <T> @Nullable Set<T> copyIfNotNull(@Nullable Set<T> set) {
        if (set == null) {
            return null;
        }
     ...
     */
    public static <T> @Nullable List<T> copyIfNotNull(@Nullable List<T> list) {
        if (list == null) {
            return null;
        }
     ...
     */
    public static <K, V> @Nullable Map<K, V> copyIfNotNull(@Nullable Map<K, V> map) {
        if (map == null) {
            return null;
        }
    ...
    public static @Nullable Map<String, String> toStringValueMap(@Nullable Map<String, Object> map) {
        if (map == null) {
            return null;
        }
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            stringValueMap.put(entry.getKey(), stringValue);
        }
