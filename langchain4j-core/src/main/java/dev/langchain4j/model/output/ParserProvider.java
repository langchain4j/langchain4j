...
public interface ParserProvider {
    ...
    /**
     * Get the parser for the given type, or the default parser if no parser is available.
     * @param typeInformation the type information
     * @return the parser
     */
    ...
    /**
     * Get the parser for the given method, or a default parser if no parser is available.
     * @param method the method
     * @return the parser
     */
    ...
    /**
     * Get the parser for the given class, or a default parser if no parser is available.
     * @param clazz the class
     * @return the parser
     */
