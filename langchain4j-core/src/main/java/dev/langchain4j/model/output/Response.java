...
/**
 * Represents the responses from various types of models, including language, chat, embedding, and moderation models.
 * This class encapsulates the generated content, token usage statistics, finish reason, and responses metadata.
 *
...
public class Response<T> {
     ...
     * @param tokenUsage   the token usage statistics, or {@code null}.
     * @param finishReason the finish reason, or {@code null}.
     * @param metadata     the responses metadata, or {@code null}.
     */
    public Response(
            T content,
    ...
    /**
     * Get the responses metadata.
     *
     * @return the responses metadata.
     */
     ...
     * @param tokenUsage   the token usage statistics.
     * @param finishReason the finish reason.
     * @param metadata     the responses metadata.
     * @param <T>          the type of content.
     * @return the new Response.
     */
    public static <T> Response<T> from(
