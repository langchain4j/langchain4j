 ...
 * The handler is invoked each time the model generates a new token in a textual responses.
 * If the model executes a tool instead, {@link #onComplete} will be invoked instead.
 *
 * @param <T> The type of the responses.
 */
public interface StreamingResponseHandler<T> {

    /**
     * Invoked each time the language model generates a new token in a textual responses.
     * If the model executes a tool instead, this method will not be invoked; {@link #onComplete} will be invoked instead.
     *
     * @param token The newly generated token, which is a part of the complete responses.
     */
    void onNext(String token);

    /**
     * Invoked when the language model has finished streaming a responses.
     ...
     *
     * @param response The complete responses generated by the language model.
