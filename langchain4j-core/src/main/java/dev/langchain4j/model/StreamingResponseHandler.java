...
public interface StreamingResponseHandler<T> {
    ...
    /**
     * Invoked each time the language model generates a new token in a reasoning content response.
     * @param token The newly generated token, which is a part of the complete reasoning content.
     */
     ...
     *                 If it is a response from a reasoning large model, it should also include the reasoning content.
     */
