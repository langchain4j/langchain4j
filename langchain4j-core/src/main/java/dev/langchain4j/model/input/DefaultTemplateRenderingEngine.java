...
class DefaultTemplateRenderingEngine implements TemplateRenderingEngine {
    ...
    @Override
    public Prompt render(final Template template,
    ...
    private void ensureAllVariablesProvided(final Set<String> allVariables,
                                            final Map<String, Object> providedVariables) {
