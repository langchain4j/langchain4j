...
public interface TokenCountEstimator {
    ...
    /**
     * Estimates the count of tokens in the specified list of text segments.
     * @param textSegments the list of text segments
     * @return the estimated count of tokens
     */
    default int estimateTextSegmentsTokenCount(List<TextSegment> textSegments) {
        int tokenCount = 0;
