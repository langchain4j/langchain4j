 ...
 */
public interface StreamingChatResponseHandler { // TODO name, make sure consistent with ChatResponse
    // TODO package
     ...
     */
    void onNext(String token); // TODO partialResponse (Some LLM providers batch tokens)? make sure consistent with ChatResponse

    /**
     * Invoked when the language model has finished streaming a response.
     * If the model executes one or multiple tools, this is accessible via {@link AiMessage#toolExecutionRequests()}.
     *
