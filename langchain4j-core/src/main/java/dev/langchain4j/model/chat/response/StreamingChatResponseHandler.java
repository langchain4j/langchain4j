...
/**
 * Represents a handler for a {@link StreamingChatModel} responses.
 *
...
public interface StreamingChatResponseHandler {
    ...
    /**
     * Invoked each time the model generates a partial textual responses, usually a single token.
     * <p>
     ...
     *
     * @param partialResponse A partial textual responses, usually a single token.
     ...
     *
     * @param partialResponse A partial textual responses, usually a single token.
     * @param context         A partial responses context.
    ...
    /**
     * Invoked when the model has finished streaming a responses.
     *
     * @param completeResponse The complete responses generated by the model,
