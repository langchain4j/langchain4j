 ...
 * dedicated {@link ChatModelStreamingEvent} type — for example a web-search, citation or reasoning-summary event.
 ...
 * <p>
 * This is the reactive ({@link ChatModelStreamingEvent} publisher) counterpart of the handler-based
...
public interface RawStreamingEvent extends ChatModelStreamingEvent {
    ...
    /**
     * The raw provider streaming event that LangChain4j does not map to a typed {@link ChatModelStreamingEvent}.
     * <p>
