...
/**
 * A filter that checks if the value of a metadata key does not contain a specific string.
 * The value of the metadata key must be a string or a UUID.
 */
public class NotContains implements Filter {

    private final String key;
    private final String comparisonValue;

    public NotContains(String key, String comparisonValue) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof NotContains other)) return false;
    ...
    public String toString() {
        return "NotContains(key=" + this.key + ", comparisonValue=" + this.comparisonValue + ")";
    }
}
