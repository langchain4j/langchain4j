...
public class TextFile {
    ...
    /**
     * Create a new {@link TextFile} from the Builder.
     ...
     * @return the url of the text file, or null if not set.
     */
    public URI url() {
        return url;
    }
     ...
     * @return the base64 data of the text file content, or null if not set.
     */
     ...
     * @return the mime type of the text file, or null if not set.
     */
    ...
    public static class Builder {
         ...
         * @param url the url of the text document.
         * @return {@code this}
         */
         ...
         * @param base64Data the base64 data of the text document.
         * @return {@code this}
         */
         ...
         * @param mimeType the mime type of the text document.
         * @return {@code this}
         */
        ...
        /**
         * Build the {@link TextFile}.
         * @return the {@link TextFile}.
         */
