...
public class AiMessage implements ChatMessage {
    ...
    public AiMessage(Builder builder) {
        ...
        this.attributes = copyToConcurrentHashMap(builder.attributes);
    }

    private static ConcurrentHashMap<String, Object> copyToConcurrentHashMap(Map<String, Object> source) {
     ...
     * The returned map is mutable, allowing tools and middlewares to write context mid-pipeline.
     *
