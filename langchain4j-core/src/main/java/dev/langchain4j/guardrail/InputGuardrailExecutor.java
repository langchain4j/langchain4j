 ...
 */
public final class InputGuardrailExecutor
        extends AbstractGuardrailExecutor<
                InputGuardrailsConfig, InputGuardrailParams, InputGuardrailResult, InputGuardrail, Failure> {

    private InputGuardrailExecutor(InputGuardrailsConfig config, @Nullable List<InputGuardrail> guardrails) {
     ...
     */
    public static final class InputGuardrailExecutorBuilder
