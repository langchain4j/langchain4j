...
public record OutputGuardrailResult(
    ...
    /**
     * Gets the {@link Response} computed from the combination of the original {@link Response} in the {@link OutputGuardrailParams}
     * and this result
     * @param params The output guardrail params
     * @return A {@link Response} computed from the combination of the original {@link Response} in the {@link OutputGuardrailParams}
     * and this result
     */
    public ChatResponse response(OutputGuardrailParams params) {
        var response = params.responseFromLLM();

        if (hasRewrittenResult()) {
            var aiMessage = response.aiMessage();
            var newAiMessage = aiMessage.hasToolExecutionRequests()
