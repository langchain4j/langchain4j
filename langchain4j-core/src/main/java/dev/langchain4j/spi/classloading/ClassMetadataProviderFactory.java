 ...
 * <p>
 *     {@link dev.langchain4j.classloading.ReflectionBasedClassMetadataProviderFactory ReflectionBasedClassMetadataProviderFactory}
...
public interface ClassMetadataProviderFactory<MethodKey> {
    ...
    /**
     * Retrieves an iterable containing method keys (MK) for all non-static methods
