...
class SearchApiRequest {
	...
	/** Geographic Location */
	/*
	 * Location from where you want the search to originate. Examples "new york" or
	 * "london". Valid values see: https://www.searchapi.io/docs/locations-api
	 */
	...
	/** Localization */
	/*
	 * The Google domain of the search. Defaults to "google.com". Full list of
	 * supported Google domains, see:
	 * https://www.searchapi.io/docs/parameters/google/domain.
	 */
	private String googleDomain;

	/*
	 * Together hl & gl when concatenated become "en-us". /* Two-letter language
	 * code for the search interface. Defaults to "en". Full list of supported "hl"
	 * values, see https://www.searchapi.io/docs/parameters/google/hl.
	 */
	private String hl;

	/*
	 * Two-letter country code for the search language. Defaults to "us". Full list
	 * of supported "gl" values, see
	...
	/*
	 * "Duplicate Content" and "Host Crowding" filters. Defaults to "1" (enabled).
	...
	/*
	 * Returns a map of key-value pairs representing optional parameters for the
	 * search request.
	 */
	public Map<String, Object> getOptionalParameters() {
		...
		if (isNotNullOrBlank(hl))
			params.put("hl", getOrDefault(hl, "en"));
		if (isNotNullOrBlank(gl))
			params.put("gl", getOrDefault(gl, "us"));
		if (safe)
