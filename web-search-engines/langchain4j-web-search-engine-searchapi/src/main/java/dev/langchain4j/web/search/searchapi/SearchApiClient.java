...
public class SearchApiClient {
	...
	@Builder
	public SearchApiClient(final String baseUrl, final String apiKey, final String engine, final Duration timeout,
			final boolean logRequests) {
		this.apiKey = apiKey;
		this.engine = engine;
		this.logRequests = logRequests;

		final OkHttpClient.Builder okHttpClientBuilder = new OkHttpClient.Builder().callTimeout(timeout)
		...
		final Retrofit retrofit = new Retrofit.Builder().baseUrl(baseUrl).client(okHttpClientBuilder.build())
