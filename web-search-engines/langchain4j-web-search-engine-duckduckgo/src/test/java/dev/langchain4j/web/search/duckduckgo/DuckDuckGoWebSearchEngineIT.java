...
class DuckDuckGoWebSearchEngineIT extends WebSearchEngineIT {
    ...
    void should_search_async_in_parallel() throws Exception {
        ...
        WebSearchRequest req1 = WebSearchRequest.builder().searchTerms("Java").maxResults(2).build();
        WebSearchRequest req2 = WebSearchRequest.builder().searchTerms("Javascript").maxResults(2).build();
